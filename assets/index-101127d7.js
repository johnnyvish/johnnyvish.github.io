...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Xn,depthTest:!1,depthWrite:!1})}function nc(){return new Mn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Do(),fragmentShader:`
		...
		`,blending:Xn,depthTest:!1,depthWrite:!1})}function ic(){return new Mn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Do(),fragmentShader:`
...
#define LOW_PRECISION`),t}function mg(r){let t="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===Jc?t="SHADOWMAP_TYPE_PCF":r.shadowMapType===kh?t="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===Pn&&(t="SHADOWMAP_TYPE_VSM"),t}function _g(r){let t="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case tr:case er:t="ENVMAP_TYPE_CUBE";break;case Ws:t="ENVMAP_TYPE_CUBE_UV";break}return t}function gg(r){let t="ENVMAP_MODE_REFLECTION";if(r.envMap)switch(r.envMapMode){case er:t="ENVMAP_MODE_REFRACTION";break}return t}function vg(r){let t="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case wo:t="ENVMAP_BLENDING_MULTIPLY";break;case lf:t="ENVMAP_BLENDING_MIX";break;case cf:t="ENVMAP_BLENDING_ADD";break}return t}function xg(r){const t=r.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function Mg(r,t,e,n){const i=r.getContext(),s=e.defines;let a=e.vertexShader,o=e.fragmentShader;const l=mg(e),c=_g(e),u=gg(e),h=vg(e),f=xg(e),p=e.isWebGL2?"":lg(e),g=cg(s),_=i.createProgram();let m,d,S=e.glslVersion?"#version "+e.glslVersion+`
...
*/var Ve={autoSleep:120,force3D:"auto",nullTargetWarn:1,units:{lineHeight:""}},sr={duration:.5,overwrite:!1,delay:0},zo,ye,oe,je=1e8,Jt=1/je,co=Math.PI*2,Q0=co/4,tv=0,Iu=Math.sqrt,ev=Math.cos,nv=Math.sin,pe=function(t){return typeof t=="string"},te=function(t){return typeof t=="function"},Nn=function(t){return typeof t=="number"},Bo=function(t){return typeof t>"u"},Sn=function(t){return typeof t=="object"},Ie=function(t){return t!==!1},Go=function(){return typeof window<"u"},As=function(t){return te(t)||pe(t)},Nu=typeof ArrayBuffer=="function"&&ArrayBuffer.isView||function(){},Ee=Array.isArray,uo=/(?:-?\.?\d|\.)+/gi,Fu=/[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g,Xi=/[-+=.]*\d+[.e-]*\d*[a-z%]*/g,za=/[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi,Ou=/[+-]=-?[.\d]+/,zu=/[^,'"\[\]\s]+/gi,iv=/^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i,jt,Ze,ho,ko,We={},Is={},Bu,Gu=function(t){return(Is=yi(t,We))&&Oe},Ho=function(t,e){return console.warn("Invalid property",t,"set to",e,"Missing plugin? gsap.registerPlugin()")},Ns=function(t,e){return!e&&console.warn(t)},ku=function(t,e){return t&&(We[t]=e)&&Is&&(Is[t]=e)||We},Hr=function(){return 0},rv={suppressEvents:!0,isStart:!0,kill:!1},Ps={suppressEvents:!0,kill:!1},sv={suppressEvents:!0},Vo={},qn=[],fo={},Hu,ke={},Ba={},Pc=30,Ls=[],Wo="",Xo=function(t){var e=t[0],n,i;if(Sn(e)||te(e)||(t=[t]),!(n=(e._gsap||{}).harness)){for(i=Ls.length;i--&&!Ls[i].targetTest(e););n=Ls[i]}for(i=t.length;i--;)t[i]&&(t[i]._gsap||(t[i]._gsap=new fh(t[i],n)))||t.splice(i,1);return t},gi=function(t){return t._gsap||Xo($e(t))[0]._gsap},Vu=function(t,e,n){return(n=t[e])&&te(n)?t[e]():Bo(n)&&t.getAttribute&&t.getAttribute(e)||n},Ne=function(t,e){return(t=t.split(",")).forEach(e)||t},ie=function(t){return Math.round(t*1e5)/1e5||0},_e=function(t){return Math.round(t*1e7)/1e7||0},ji=function(t,e){var n=e.charAt(0),i=parseFloat(e.substr(2));return t=parseFloat(t),n==="+"?t+i:n==="-"?t-i:n==="*"?t*i:t/i},av=function(t,e){for(var n=e.length,i=0;t.indexOf(e[i])<0&&++i<n;);return i<n},Fs=function(){var t=qn.length,e=qn.slice(0),n,i;for(fo={},qn.length=0,n=0;n<t;n++)i=e[n],i&&i._lazy&&(i.render(i._lazy[0],i._lazy[1],!0)._lazy=0)},Wu=function(t,e,n,i){qn.length&&!ye&&Fs(),t.render(e,n,i||ye&&e<0&&(t._initted||t._startAt)),qn.length&&!ye&&Fs()},Xu=function(t){var e=parseFloat(t);return(e||e===0)&&(t+"").match(zu).length<2?e:pe(t)?t.trim():t},qu=function(t){return t},tn=function(t,e){for(var n in e)n in t||(t[n]=e[n]);return t},ov=function(t){return function(e,n){for(var i in n)i in e||i==="duration"&&t||i==="ease"||(e[i]=n[i])}},yi=function(t,e){for(var n in e)t[n]=e[n];return t},Lc=function r(t,e){for(var n in e)n!=="__proto__"&&n!=="constructor"&&n!=="prototype"&&(t[n]=Sn(e[n])?r(t[n]||(t[n]={}),e[n]):e[n]);return t},Os=function(t,e){var n={},i;for(i in t)i in e||(n[i]=t[i]);return n},Lr=function(t){var e=t.parent||jt,n=t.keyframes?ov(Ee(t.keyframes)):tn;if(Ie(t.inherit))for(;e;)n(t,e.vars.defaults),e=e.parent||e._dp;return t},lv=function(t,e){for(var n=t.length,i=n===e.length;i&&n--&&t[n]===e[n];);return n<0},Yu=function(t,e,n,i,s){n===void 0&&(n="_first"),i===void 0&&(i="_last");var a=t[i],o;if(s)for(o=e[s];a&&a[s]>o;)a=a._prev;return a?(e._next=a._next,a._next=e):(e._next=t[n],t[n]=e),e._next?e._next._prev=e:t[i]=e,e._prev=a,e.parent=e._dp=t,e},js=function(t,e,n,i){n===void 0&&(n="_first"),i===void 0&&(i="_last");var s=e._prev,a=e._next;s?s._next=a:t[n]===e&&(t[n]=a),a?a._prev=s:t[i]===e&&(t[i]=s),e._next=e._prev=e.parent=null},Jn=function(t,e){t.parent&&(!e||t.parent.autoRemoveChildren)&&t.parent.remove(t),t._act=0},vi=function(t,e){if(t&&(!e||e._end>t._dur||e._start<0))for(var n=t;n;)n._dirty=1,n=n.parent;return t},cv=function(t){for(var e=t.parent;e&&e.parent;)e._dirty=1,e.totalDuration(),e=e.parent;return t},po=function(t,e,n,i){return t._startAt&&(ye?t._startAt.revert(Ps):t.vars.immediateRender&&!t.vars.autoRevert||t._startAt.render(e,!0,i))},uv=function r(t){return!t||t._ts&&r(t.parent)},Dc=function(t){return t._repeat?ar(t._tTime,t=t.duration()+t._rDelay)*t:0},ar=function(t,e){var n=Math.floor(t/=e);return t&&n===t?n-1:n},zs=function(t,e){return(t-e._start)*e._ts+(e._ts>=0?0:e._dirty?e.totalDuration():e._tDur)},$s=function(t){return t._end=_e(t._start+(t._tDur/Math.abs(t._ts||t._rts||Jt)||0))},Qs=function(t,e){var n=t._dp;return n&&n.smoothChildTiming&&t._ts&&(t._start=_e(n._time-(t._ts>0?e/t._ts:((t._dirty?t.totalDuration():t._tDur)-e)/-t._ts)),$s(t),n._dirty||vi(n,t)),t},Zu=function(t,e){var n;if((e._time||e._initted&&!e._dur)&&(n=zs(t.rawTime(),e),(!e._dur||$r(0,e.totalDuration(),n)-e._tTime>Jt)&&e.render(n,!0)),vi(t,e)._dp&&t._initted&&t._time>=t._dur&&t._ts){if(t._dur<t.duration())for(n=t;n._dp;)n.rawTime()>=0&&n.totalTime(n._tTime),n=n._dp;t._zTime=-Jt}},mn=function(t,e,n,i){return e.parent&&Jn(e),e._start=_e((Nn(n)?n:n||t!==jt?Ye(t,n,e):t._time)+e._delay),e._end=_e(e._start+(e.totalDuration()/Math.abs(e.timeScale())||0)),Yu(t,e,"_first","_last",t._sort?"_start":0),mo(e)||(t._recent=e),i||Zu(t,e),t._ts<0&&Qs(t,t._tTime),t},Ku=function(t,e){return(We.ScrollTrigger||Ho("scrollTrigger",e))&&We.ScrollTrigger.create(e,t)},Ju=function(t,e,n,i,s){if(Yo(t,e,s),!t._initted)return 1;if(!n&&t._pt&&!ye&&(t._dur&&t.vars.lazy!==!1||!t._dur&&t.vars.lazy)&&Hu!==He.frame)return qn.push(t),t._lazy=[s,i],1},hv=function r(t){var e=t.parent;return e&&e._ts&&e._initted&&!e._lock&&(e.rawTime()<0||r(e))},mo=function(t){var e=t.data;return e==="isFromStart"||e==="isStart"},fv=function(t,e,n,i){var s=t.ratio,a=e<0||!e&&(!t._start&&hv(t)&&!(!t._initted&&mo(t))||(t._ts<0||t._dp._ts<0)&&!mo(t))?0:1,o=t._rDelay,l=0,c,u,h;if(o&&t._repeat&&(l=$r(0,t._tDur,e),u=ar(l,o),t._yoyo&&u&1&&(a=1-a),u!==ar(t._tTime,o)&&(s=1-a,t.vars.repeatRefresh&&t._initted&&t.invalidate())),a!==s||ye||i||t._zTime===Jt||!e&&t._zTime){if(!t._initted&&Ju(t,e,i,n,l))return;for(h=t._zTime,t._zTime=e||(n?Jt:0),n||(n=e&&!h),t.ratio=a,t._from&&(a=1-a),t._time=0,t._tTime=l,c=t._pt;c;)c.r(a,c.d),c=c._next;e<0&&po(t,e,n,!0),t._onUpdate&&!n&&Qe(t,"onUpdate"),l&&t._repeat&&!n&&t.parent&&Qe(t,"onRepeat"),(e>=t._tDur||e<0)&&t.ratio===a&&(a&&Jn(t,1),!n&&!ye&&(Qe(t,a?"onComplete":"onReverseComplete",!0),t._prom&&t._prom()))}else t._zTime||(t._zTime=e)},dv=function(t,e,n){var i;if(n>e)for(i=t._first;i&&i._start<=n;){if(i.data==="isPause"&&i._start>e)return i;i=i._next}else for(i=t._last;i&&i._start>=n;){if(i.data==="isPause"&&i._start<e)return i;i=i._prev}},or=function(t,e,n,i){var s=t._repeat,a=_e(e)||0,o=t._tTime/t._tDur;return o&&!i&&(t._time*=a/t._dur),t._dur=a,t._tDur=s?s<0?1e10:_e(a*(s+1)+t._rDelay*s):a,o>0&&!i&&Qs(t,t._tTime=t._tDur*o),t.parent&&$s(t),n||vi(t.parent,t),t},Uc=function(t){return t instanceof De?vi(t):or(t,t._dur)},pv={_start:0,endTime:Hr,totalDuration:Hr},Ye=function r(t,e,n){var i=t.labels,s=t._recent||pv,a=t.duration()>=je?s.endTime(!1):t._dur,o,l,c;return pe(e)&&(isNaN(e)||e in i)?(l=e.charAt(0),c=e.substr(-1)==="%",o=e.indexOf("="),l==="<"||l===">"?(o>=0&&(e=e.replace(/=/,"")),(l==="<"?s._start:s.endTime(s._repeat>=0))+(parseFloat(e.substr(1))||0)*(c?(o<0?s:n).totalDuration()/100:1)):o<0?(e in i||(i[e]=a),i[e]):(l=parseFloat(e.charAt(o-1)+e.substr(o+1)),c&&n&&(l=l/100*(Ee(n)?n[0]:n).totalDuration()),o>1?r(t,e.substr(0,o-1),n)+l:a+l)):e==null?a:+e},Dr=function(t,e,n){var i=Nn(e[1]),s=(i?2:1)+(t<2?0:1),a=e[s],o,l;if(i&&(a.duration=e[1]),a.parent=n,t){for(o=a,l=n;l&&!("immediateRender"in o);)o=l.vars.defaults||{},l=Ie(l.vars.inherit)&&l.parent;a.immediateRender=Ie(o.immediateRender),t<2?a.runBackwards=1:a.startAt=e[s-1]}return new le(e[0],a,e[s+1])},$n=function(t,e){return t||t===0?e(t):e},$r=function(t,e,n){return n<t?t:n>e?e:n},Se=function(t,e){return!pe(t)||!(e=iv.exec(t))?"":e[1]},mv=function(t,e,n){return $n(n,function(i){return $r(t,e,i)})},_o=[].slice,ju=function(t,e){return t&&Sn(t)&&"length"in t&&(!e&&!t.length||t.length-1 in t&&Sn(t[0]))&&!t.nodeType&&t!==Ze},_v=function(t,e,n){return n===void 0&&(n=[]),t.forEach(function(i){var s;return pe(i)&&!e||ju(i,1)?(s=n).push.apply(s,$e(i)):n.push(i)})||n},$e=function(t,e,n){return oe&&!e&&oe.selector?oe.selector(t):pe(t)&&!n&&(ho||!lr())?_o.call((e||ko).querySelectorAll(t),0):Ee(t)?_v(t,n):ju(t)?_o.call(t,0):t?[t]:[]},go=function(t){return t=$e(t)[0]||Ns("Invalid scope")||{},function(e){var n=t.current||t.nativeElement||t;return $e(e,n.querySelectorAll?n:n===t?Ns("Invalid scope")||ko.createElement("div"):t)}},$u=function(t){return t.sort(function(){return .5-Math.random()})},Qu=function(t){if(te(t))return t;var e=Sn(t)?t:{each:t},n=xi(e.ease),i=e.from||0,s=parseFloat(e.base)||0,a={},o=i>0&&i<1,l=isNaN(i)||o,c=e.axis,u=i,h=i;return pe(i)?u=h={center:.5,edges:.5,end:1}[i]||0:!o&&l&&(u=i[0],h=i[1]),function(f,p,g){var _=(g||e).length,m=a[_],d,S,x,M,y,T,R,C,v;if(!m){if(v=e.grid==="auto"?0:(e.grid||[1,je])[1],!v){for(R=-je;R<(R=g[v++].getBoundingClientRect().left)&&v<_;);v--}for(m=a[_]=[],d=l?Math.min(v,_)*u-.5:i%v,S=v===je?0:l?_*h/v-.5:i/v|0,R=0,C=je,T=0;T<_;T++)x=T%v-d,M=S-(T/v|0),m[T]=y=c?Math.abs(c==="y"?M:x):Iu(x*x+M*M),y>R&&(R=y),y<C&&(C=y);i==="random"&&$u(m),m.max=R-C,m.min=C,m.v=_=(parseFloat(e.amount)||parseFloat(e.each)*(v>_?_-1:c?c==="y"?_/v:v:Math.max(v,_/v))||0)*(i==="edges"?-1:1),m.b=_<0?s-_:s,m.u=Se(e.amount||e.each)||0,n=n&&_<0?ch(n):n}return _=(m[f]-m.min)/m.max||0,_e(m.b+(n?n(_):_)*m.v)+m.u}},vo=function(t){var e=Math.pow(10,((t+"").split(".")[1]||"").length);return function(n){var i=_e(Math.round(parseFloat(n)/t)*t*e);return(i-i%1)/e+(Nn(n)?0:Se(n))}},th=function(t,e){var n=Ee(t),i,s;return!n&&Sn(t)&&(i=n=t.radius||je,t.values?(t=$e(t.values),(s=!Nn(t[0]))&&(i*=i)):t=vo(t.increment)),$n(e,n?te(t)?function(a){return s=t(a),Math.abs(s-a)<=i?s:a}:function(a){for(var o=parseFloat(s?a.x:a),l=parseFloat(s?a.y:0),c=je,u=0,h=t.length,f,p;h--;)s?(f=t[h].x-o,p=t[h].y-l,f=f*f+p*p):f=Math.abs(t[h]-o),f<c&&(c=f,u=h);return u=!i||c<=i?t[u]:a,s||u===a||Nn(a)?u:u+Se(a)}:vo(t))},eh=function(t,e,n,i){return $n(Ee(t)?!e:n===!0?!!(n=0):!i,function(){return Ee(t)?t[~~(Math.random()*t.length)]:(n=n||1e-5)&&(i=n<1?Math.pow(10,(n+"").length-2):1)&&Math.floor(Math.round((t-n/2+Math.random()*(e-t+n*.99))/n)*n*i)/i})},gv=function(){for(var t=arguments.length,e=new Array(t),n=0;n<t;n++)e[n]=arguments[n];return function(i){return e.reduce(function(s,a){return a(s)},i)}},vv=function(t,e){return function(n){return t(parseFloat(n))+(e||Se(n))}},xv=function(t,e,n){return ih(t,e,0,1,n)},nh=function(t,e,n){return $n(n,function(i){return t[~~e(i)]})},Mv=function r(t,e,n){var i=e-t;return Ee(t)?nh(t,r(0,t.length),e):$n(n,function(s){return(i+(s-t)%i)%i+t})},Sv=function r(t,e,n){var i=e-t,s=i*2;return Ee(t)?nh(t,r(0,t.length-1),e):$n(n,function(a){return a=(s+(a-t)%s)%s||0,t+(a>i?s-a:a)})},Vr=function(t){for(var e=0,n="",i,s,a,o;~(i=t.indexOf("random(",e));)a=t.indexOf(")",i),o=t.charAt(i+7)==="[",s=t.substr(i+7,a-i-7).match(o?zu:uo),n+=t.substr(e,i-e)+eh(o?s:+s[0],o?0:+s[1],+s[2]||1e-5),e=a+1;return n+t.substr(e,t.length-e)},ih=function(t,e,n,i,s){var a=e-t,o=i-n;return $n(s,function(l){return n+((l-t)/a*o||0)})},yv=function r(t,e,n,i){var s=isNaN(t+e)?0:function(p){return(1-p)*t+p*e};if(!s){var a=pe(t),o={},l,c,u,h,f;if(n===!0&&(i=1)&&(n=null),a)t={p:t},e={p:e};else if(Ee(t)&&!Ee(e)){for(u=[],h=t.length,f=h-2,c=1;c<h;c++)u.push(r(t[c-1],t[c]));h--,s=function(g){g*=h;var _=Math.min(f,~~g);return u[_](g-_)},n=e}else i||(t=yi(Ee(t)?[]:{},t));if(!u){for(l in e)qo.call(o,t,l,"get",e[l]);s=function(g){return Jo(g,o)||(a?t.p:t)}}}return $n(n,s)},Ic=function(t,e,n){var i=t.labels,s=je,a,o,l;for(a in i)o=i[a]-e,o<0==!!n&&o&&s>(o=Math.abs(o))&&(l=a,s=o);return l},Qe=function(t,e,n){var i=t.vars,s=i[e],a=oe,o=t._ctx,l,c,u;if(s)return l=i[e+"Params"],c=i.callbackScope||t,n&&qn.length&&Fs(),o&&(oe=o),u=l?s.apply(c,l):s.call(c),oe=a,u},Tr=function(t){return Jn(t),t.scrollTrigger&&t.scrollTrigger.kill(!!ye),t.progress()<1&&Qe(t,"onInterrupt"),t},qi,rh=[],sh=function(t){if(!Go()){rh.push(t);return}t=!t.name&&t.default||t;var e=t.name,n=te(t),i=e&&!n&&t.init?function(){this._props=[]}:t,s={init:Hr,render:Jo,add:qo,kill:zv,modifier:Ov,rawVars:0},a={targetTest:0,get:0,getSetter:Ko,aliases:{},register:0};if(lr(),t!==i){if(ke[e])return;tn(i,tn(Os(t,s),a)),yi(i.prototype,yi(s,Os(t,a))),ke[i.prop=e]=i,t.targetTest&&(Ls.push(i),Vo[e]=1),e=(e==="css"?"CSS":e.charAt(0).toUpperCase()+e.substr(1))+"Plugin"}ku(e,i),t.register&&t.register(Oe,i,Fe)},Kt=255,br={aqua:[0,Kt,Kt],lime:[0,Kt,0],silver:[192,192,192],black:[0,0,0],maroon:[128,0,0],teal:[0,128,128],blue:[0,0,Kt],navy:[0,0,128],white:[Kt,Kt,Kt],olive:[128,128,0],yellow:[Kt,Kt,0],orange:[Kt,165,0],gray:[128,128,128],purple:[128,0,128],green:[0,128,0],red:[Kt,0,0],pink:[Kt,192,203],cyan:[0,Kt,Kt],transparent:[Kt,Kt,Kt,0]},Ga=function(t,e,n){return t+=t<0?1:t>1?-1:0,(t*6<1?e+(n-e)*t*6:t<.5?n:t*3<2?e+(n-e)*(2/3-t)*6:e)*Kt+.5|0},ah=function(t,e,n){var i=t?Nn(t)?[t>>16,t>>8&Kt,t&Kt]:0:br.black,s,a,o,l,c,u,h,f,p,g;if(!i){if(t.substr(-1)===","&&(t=t.substr(0,t.length-1)),br[t])i=br[t];else if(t.charAt(0)==="#"){if(t.length<6&&(s=t.charAt(1),a=t.charAt(2),o=t.charAt(3),t="#"+s+s+a+a+o+o+(t.length===5?t.charAt(4)+t.charAt(4):"")),t.length===9)return i=parseInt(t.substr(1,6),16),[i>>16,i>>8&Kt,i&Kt,parseInt(t.substr(7),16)/255];t=parseInt(t.substr(1),16),i=[t>>16,t>>8&Kt,t&Kt]}else if(t.substr(0,3)==="hsl"){if(i=g=t.match(uo),!e)l=+i[0]%360/360,c=+i[1]/100,u=+i[2]/100,a=u<=.5?u*(c+1):u+c-u*c,s=u*2-a,i.length>3&&(i[3]*=1),i[0]=Ga(l+1/3,s,a),i[1]=Ga(l,s,a),i[2]=Ga(l-1/3,s,a);else if(~t.indexOf("="))return i=t.match(Fu),n&&i.length<4&&(i[3]=1),i}else i=t.match(uo)||br.transparent;i=i.map(Number)}return e&&!g&&(s=i[0]/Kt,a=i[1]/Kt,o=i[2]/Kt,h=Math.max(s,a,o),f=Math.min(s,a,o),u=(h+f)/2,h===f?l=c=0:(p=h-f,c=u>.5?p/(2-h-f):p/(h+f),l=h===s?(a-o)/p+(a<o?6:0):h===a?(o-s)/p+2:(s-a)/p+4,l*=60),i[0]=~~(l+.5),i[1]=~~(c*100+.5),i[2]=~~(u*100+.5)),n&&i.length<4&&(i[3]=1),i},oh=function(t){var e=[],n=[],i=-1;return t.split(Yn).forEach(function(s){var a=s.match(Xi)||[];e.push.apply(e,a),n.push(i+=a.length+1)}),e.c=n,e},Nc=function(t,e,n){var i="",s=(t+i).match(Yn),a=e?"hsla(":"rgba(",o=0,l,c,u,h;if(!s)return t;if(s=s.map(function(f){return(f=ah(f,e,1))&&a+(e?f[0]+","+f[1]+"%,"+f[2]+"%,"+f[3]:f.join(","))+")"}),n&&(u=oh(t),l=n.c,l.join(i)!==u.c.join(i)))for(c=t.replace(Yn,"1").split(Xi),h=c.length-1;o<h;o++)i+=c[o]+(~l.indexOf(o)?s.shift()||a+"0,0,0,0)":(u.length?u:s.length?s:n).shift());if(!c)for(c=t.split(Yn),h=c.length-1;o<h;o++)i+=c[o]+s[o];return i+c[h]},Yn=function(){var r="(?:\\b(?:(?:rgb|rgba|hsl|hsla)\\(.+?\\))|\\B#(?:[0-9a-f]{3,4}){1,2}\\b",t;for(t in br)r+="|"+t+"\\b";return new RegExp(r+")","gi")}(),Ev=/hsl[a]?\(/,lh=function(t){var e=t.join(" "),n;if(Yn.lastIndex=0,Yn.test(e))return n=Ev.test(e),t[1]=Nc(t[1],n),t[0]=Nc(t[0],n,oh(t[1])),!0},Wr,He=function(){var r=Date.now,t=500,e=33,n=r(),i=n,s=1e3/240,a=s,o=[],l,c,u,h,f,p,g=function _(m){var d=r()-i,S=m===!0,x,M,y,T;if(d>t&&(n+=d-e),i+=d,y=i-n,x=y-a,(x>0||S)&&(T=++h.frame,f=y-h.time*1e3,h.time=y=y/1e3,a+=x+(x>=s?4:s-x),M=1),S||(l=c(_)),M)for(p=0;p<o.length;p++)o[p](y,f,T,m)};return h={time:0,frame:0,tick:function(){g(!0)},deltaRatio:function(m){return f/(1e3/(m||60))},wake:function(){Bu&&(!ho&&Go()&&(Ze=ho=window,ko=Ze.document||{},We.gsap=Oe,(Ze.gsapVersions||(Ze.gsapVersions=[])).push(Oe.version),Gu(Is||Ze.GreenSockGlobals||!Ze.gsap&&Ze||{}),u=Ze.requestAnimationFrame,rh.forEach(sh)),l&&h.sleep(),c=u||function(m){return setTimeout(m,a-h.time*1e3+1|0)},Wr=1,g(2))},sleep:function(){(u?Ze.cancelAnimationFrame:clearTimeout)(l),Wr=0,c=Hr},lagSmoothing:function(m,d){t=m||1/0,e=Math.min(d||33,t)},fps:function(m){s=1e3/(m||240),a=h.time*1e3+s},add:function(m,d,S){var x=d?function(M,y,T,R){m(M,y,T,R),h.remove(x)}:m;return h.remove(m),o[S?"unshift":"push"](x),lr(),x},remove:function(m,d){~(d=o.indexOf(m))&&o.splice(d,1)&&p>=d&&p--},_listeners:o},h}(),lr=function(){return!Wr&&He.wake()},Gt={},Tv=/^[\d.\-M][\d.\-,\s]/,bv=/["']/g,Av=function(t){for(var e={},n=t.substr(1,t.length-3).split(":"),i=n[0],s=1,a=n.length,o,l,c;s<a;s++)l=n[s],o=s!==a-1?l.lastIndexOf(","):l.length,c=l.substr(0,o),e[i]=isNaN(c)?c.replace(bv,"").trim():+c,i=l.substr(o+1).trim();return e},wv=function(t){var e=t.indexOf("(")+1,n=t.indexOf(")"),i=t.indexOf("(",e);return t.substring(e,~i&&i<n?t.indexOf(")",n+1):n)},Rv=function(t){var e=(t+"").split("("),n=Gt[e[0]];return n&&e.length>1&&n.config?n.config.apply(null,~t.indexOf("{")?[Av(e[1])]:wv(t).split(",").map(Xu)):Gt._CE&&Tv.test(t)?Gt._CE("",t):n},ch=function(t){return function(e){return 1-t(1-e)}},uh=function r(t,e){for(var n=t._first,i;n;)n instanceof De?r(n,e):n.vars.yoyoEase&&(!n._yoyo||!n._repeat)&&n._yoyo!==e&&(n.timeline?r(n.timeline,e):(i=n._ease,n._ease=n._yEase,n._yEase=i,n._yoyo=e)),n=n._next},xi=function(t,e){return t&&(te(t)?t:Gt[t]||Rv(t))||e},Ti=function(t,e,n,i){n===void 0&&(n=function(l){return 1-e(1-l)}),i===void 0&&(i=function(l){return l<.5?e(l*2)/2:1-e((1-l)*2)/2});var s={easeIn:e,easeOut:n,easeInOut:i},a;return Ne(t,function(o){Gt[o]=We[o]=s,Gt[a=o.toLowerCase()]=n;for(var l in s)Gt[a+(l==="easeIn"?".in":l==="easeOut"?".out":".inOut")]=Gt[o+"."+l]=s[l]}),s},hh=function(t){return function(e){return e<.5?(1-t(1-e*2))/2:.5+t((e-.5)*2)/2}},ka=function r(t,e,n){var i=e>=1?e:1,s=(n||(t?.3:.45))/(e<1?e:1),a=s/co*(Math.asin(1/i)||0),o=function(u){return u===1?1:i*Math.pow(2,-10*u)*nv((u-a)*s)+1},l=t==="out"?o:t==="in"?function(c){return 1-o(1-c)}:hh(o);return s=co/s,l.config=function(c,u){return r(t,c,u)},l},Ha=function r(t,e){e===void 0&&(e=1.70158);var n=function(a){return a?--a*a*((e+1)*a+e)+1:0},i=t==="out"?n:t==="in"?function(s){return 1-n(1-s)}:hh(n);return i.config=function(s){return r(t,s)},i};Ne("Linear,Quad,Cubic,Quart,Quint,Strong",function(r,t){var e=t<5?t+1:t;Ti(r+",Power"+(e-1),t?function(n){return Math.pow(n,e)}:function(n){return n},function(n){return 1-Math.pow(1-n,e)},function(n){return n<.5?Math.pow(n*2,e)/2:1-Math.pow((1-n)*2,e)/2})});Gt.Linear.easeNone=Gt.none=Gt.Linear.easeIn;Ti("Elastic",ka("in"),ka("out"),ka());(function(r,t){var e=1/t,n=2*e,i=2.5*e,s=function(o){return o<e?r*o*o:o<n?r*Math.pow(o-1.5/t,2)+.75:o<i?r*(o-=2.25/t)*o+.9375:r*Math.pow(o-2.625/t,2)+.984375};Ti("Bounce",function(a){return 1-s(1-a)},s)})(7.5625,2.75);Ti("Expo",function(r){return r?Math.pow(2,10*(r-1)):0});Ti("Circ",function(r){return-(Iu(1-r*r)-1)});Ti("Sine",function(r){return r===1?1:-ev(r*Q0)+1});Ti("Back",Ha("in"),Ha("out"),Ha());Gt.SteppedEase=Gt.steps=We.SteppedEase={config:function(t,e){t===void 0&&(t=1);var n=1/t,i=t+(e?0:1),s=e?1:0,a=1-Jt;return function(o){return((i*$r(0,a,o)|0)+s)*n}}};sr.ease=Gt["quad.out"];Ne("onComplete,onUpdate,onStart,onRepeat,onReverseComplete,onInterrupt",function(r){return Wo+=r+","+r+"Params,"});var fh=function(t,e){this.id=tv++,t._gsap=this,this.target=t,this.harness=e,this.get=e?e.get:Vu,this.set=e?e.getSetter:Ko},cr=function(){function r(e){this.vars=e,this._delay=+e.delay||0,(this._repeat=e.repeat===1/0?-2:e.repeat||0)&&(this._rDelay=e.repeatDelay||0,this._yoyo=!!e.yoyo||!!e.yoyoEase),this._ts=1,or(this,+e.duration,1,1),this.data=e.data,oe&&(this._ctx=oe,oe.data.push(this)),Wr||He.wake()}var t=r.prototype;return t.delay=function(n){return n||n===0?(this.parent&&this.parent.smoothChildTiming&&this.startTime(this._start+n-this._delay),this._delay=n,this):this._delay},t.duration=function(n){return arguments.length?this.totalDuration(this._repeat>0?n+(n+this._rDelay)*this._repeat:n):this.totalDuration()&&this._dur},t.totalDuration=function(n){return arguments.length?(this._dirty=0,or(this,this._repeat<0?n:(n-this._repeat*this._rDelay)/(this._repeat+1))):this._tDur},t.totalTime=function(n,i){if(lr(),!arguments.length)return this._tTime;var s=this._dp;if(s&&s.smoothChildTiming&&this._ts){for(Qs(this,n),!s._dp||s.parent||Zu(s,this);s&&s.parent;)s.parent._time!==s._start+(s._ts>=0?s._tTime/s._ts:(s.totalDuration()-s._tTime)/-s._ts)&&s.totalTime(s._tTime,!0),s=s.parent;!this.parent&&this._dp.autoRemoveChildren&&(this._ts>0&&n<this._tDur||this._ts<0&&n>0||!this._tDur&&!n)&&mn(this._dp,this,this._start-this._delay)}return(this._tTime!==n||!this._dur&&!i||this._initted&&Math.abs(this._zTime)===Jt||!n&&!this._initted&&(this.add||this._ptLookup))&&(this._ts||(this._pTime=n),Wu(this,n,i)),this},t.time=function(n,i){return arguments.length?this.totalTime(Math.min(this.totalDuration(),n+Dc(this))%(this._dur+this._rDelay)||(n?this._dur:0),i):this._time},t.totalProgress=function(n,i){return arguments.length?this.totalTime(this.totalDuration()*n,i):this.totalDuration()?Math.min(1,this._tTime/this._tDur):this.ratio},t.progress=function(n,i){return arguments.length?this.totalTime(this.duration()*(this._yoyo&&!(this.iteration()&1)?1-n:n)+Dc(this),i):this.duration()?Math.min(1,this._time/this._dur):this.ratio},t.iteration=function(n,i){var s=this.duration()+this._rDelay;return arguments.length?this.totalTime(this._time+(n-1)*s,i):this._repeat?ar(this._tTime,s)+1:1},t.timeScale=function(n){if(!arguments.length)return this._rts===-Jt?0:this._rts;if(this._rts===n)return this;var i=this.parent&&this._ts?zs(this.parent._time,this):this._tTime;return this._rts=+n||0,this._ts=this._ps||n===-Jt?0:this._rts,this.totalTime($r(-Math.abs(this._delay),this._tDur,i),!0),$s(this),cv(this)},t.paused=function(n){return arguments.length?(this._ps!==n&&(this._ps=n,n?(this._pTime=this._tTime||Math.max(-this._delay,this.rawTime()),this._ts=this._act=0):(lr(),this._ts=this._rts,this.totalTime(this.parent&&!this.parent.smoothChildTiming?this.rawTime():this._tTime||this._pTime,this.progress()===1&&Math.abs(this._zTime)!==Jt&&(this._tTime-=Jt)))),this):this._ps},t.startTime=function(n){if(arguments.length){this._start=n;var i=this.parent||this._dp;return i&&(i._sort||!this.parent)&&mn(i,this,n-this._delay),this}return this._start},t.endTime=function(n){return this._start+(Ie(n)?this.totalDuration():this.duration())/Math.abs(this._ts||1)},t.rawTime=function(n){var i=this.parent||this._dp;return i?n&&(!this._ts||this._repeat&&this._time&&this.totalProgress()<1)?this._tTime%(this._dur+this._rDelay):this._ts?zs(i.rawTime(n),this):this._tTime:this._tTime},t.revert=function(n){n===void 0&&(n=sv);var i=ye;return ye=n,(this._initted||this._startAt)&&(this.timeline&&this.timeline.revert(n),this.totalTime(-.01,n.suppressEvents)),this.data!=="nested"&&n.kill!==!1&&this.kill(),ye=i,this},t.globalTime=function(n){for(var i=this,s=arguments.length?n:i.rawTime();i;)s=i._start+s/(i._ts||1),i=i._dp;return!this.parent&&this._sat?this._sat.vars.immediateRender?-1:this._sat.globalTime(n):s},t.repeat=function(n){return arguments.length?(this._repeat=n===1/0?-2:n,Uc(this)):this._repeat===-2?1/0:this._repeat},t.repeatDelay=function(n){if(arguments.length){var i=this._time;return this._rDelay=n,Uc(this),i?this.time(i):this}return this._rDelay},t.yoyo=function(n){return arguments.length?(this._yoyo=n,this):this._yoyo},t.seek=function(n,i){return this.totalTime(Ye(this,n),Ie(i))},t.restart=function(n,i){return this.play().totalTime(n?-this._delay:0,Ie(i))},t.play=function(n,i){return n!=null&&this.seek(n,i),this.reversed(!1).paused(!1)},t.reverse=function(n,i){return n!=null&&this.seek(n||this.totalDuration(),i),this.reversed(!0).paused(!1)},t.pause=function(n,i){return n!=null&&this.seek(n,i),this.paused(!0)},t.resume=function(){return this.paused(!1)},t.reversed=function(n){return arguments.length?(!!n!==this.reversed()&&this.timeScale(-this._rts||(n?-Jt:0)),this):this._rts<0},t.invalidate=function(){return this._initted=this._act=0,this._zTime=-Jt,this},t.isActive=function(){var n=this.parent||this._dp,i=this._start,s;return!!(!n||this._ts&&this._initted&&n.isActive()&&(s=n.rawTime(!0))>=i&&s<this.endTime(!0)-Jt)},t.eventCallback=function(n,i,s){var a=this.vars;return arguments.length>1?(i?(a[n]=i,s&&(a[n+"Params"]=s),n==="onUpdate"&&(this._onUpdate=i)):delete a[n],this):a[n]},t.then=function(n){var i=this;return new Promise(function(s){var a=te(n)?n:qu,o=function(){var c=i.then;i.then=null,te(a)&&(a=a(i))&&(a.then||a===i)&&(i.then=c),s(a),i.then=c};i._initted&&i.totalProgress()===1&&i._ts>=0||!i._tTime&&i._ts<0?o():i._prom=o})},t.kill=function(){Tr(this)},r}();tn(cr.prototype,{_time:0,_start:0,_end:0,_tTime:0,_tDur:0,_dirty:0,_repeat:0,_yoyo:!1,parent:null,_initted:!1,_rDelay:0,_ts:1,_dp:0,ratio:0,_zTime:-Jt,_prom:0,_ps:!1,_rts:1});var De=function(r){Uu(t,r);function t(n,i){var s;return n===void 0&&(n={}),s=r.call(this,n)||this,s.labels={},s.smoothChildTiming=!!n.smoothChildTiming,s.autoRemoveChildren=!!n.autoRemoveChildren,s._sort=Ie(n.sortChildren),jt&&mn(n.parent||jt,Ln(s),i),n.reversed&&s.reverse(),n.paused&&s.paused(!0),n.scrollTrigger&&Ku(Ln(s),n.scrollTrigger),s}var e=t.prototype;return e.to=function(i,s,a){return Dr(0,arguments,this),this},e.from=function(i,s,a){return Dr(1,arguments,this),this},e.fromTo=function(i,s,a,o){return Dr(2,arguments,this),this},e.set=function(i,s,a){return s.duration=0,s.parent=this,Lr(s).repeatDelay||(s.repeat=0),s.immediateRender=!!s.immediateRender,new le(i,s,Ye(this,a),1),this},e.call=function(i,s,a){return mn(this,le.delayedCall(0,i,s),a)},e.staggerTo=function(i,s,a,o,l,c,u){return a.duration=s,a.stagger=a.stagger||o,a.onComplete=c,a.onCompleteParams=u,a.parent=this,new le(i,a,Ye(this,l)),this},e.staggerFrom=function(i,s,a,o,l,c,u){return a.runBackwards=1,Lr(a).immediateRender=Ie(a.immediateRender),this.staggerTo(i,s,a,o,l,c,u)},e.staggerFromTo=function(i,s,a,o,l,c,u,h){return o.startAt=a,Lr(o).immediateRender=Ie(o.immediateRender),this.staggerTo(i,s,o,l,c,u,h)},e.render=function(i,s,a){var o=this._time,l=this._dirty?this.totalDuration():this._tDur,c=this._dur,u=i<=0?0:_e(i),h=this._zTime<0!=i<0&&(this._initted||!c),f,p,g,_,m,d,S,x,M,y,T,R;if(this!==jt&&u>l&&i>=0&&(u=l),u!==this._tTime||a||h){if(o!==this._time&&c&&(u+=this._time-o,i+=this._time-o),f=u,M=this._start,x=this._ts,d=!x,h&&(c||(o=this._zTime),(i||!s)&&(this._zTime=i)),this._repeat){if(T=this._yoyo,m=c+this._rDelay,this._repeat<-1&&i<0)return this.totalTime(m*100+i,s,a);if(f=_e(u%m),u===l?(_=this._repeat,f=c):(_=~~(u/m),_&&_===u/m&&(f=c,_--),f>c&&(f=c)),y=ar(this._tTime,m),!o&&this._tTime&&y!==_&&this._tTime-y*m-this._dur<=0&&(y=_),T&&_&1&&(f=c-f,R=1),_!==y&&!this._lock){var C=T&&y&1,v=C===(T&&_&1);if(_<y&&(C=!C),o=C?0:c,this._lock=1,this.render(o||(R?0:_e(_*m)),s,!c)._lock=0,this._tTime=u,!s&&this.parent&&Qe(this,"onRepeat"),this.vars.repeatRefresh&&!R&&(this.invalidate()._lock=1),o&&o!==this._time||d!==!this._ts||this.vars.onRepeat&&!this.parent&&!this._act)return this;if(c=this._dur,l=this._tDur,v&&(this._lock=2,o=C?c:-1e-4,this.render(o,!0),this.vars.repeatRefresh&&!R&&this.invalidate()),this._lock=0,!this._ts&&!d)return this;uh(this,R)}}if(this._hasPause&&!this._forcing&&this._lock<2&&(S=dv(this,_e(o),_e(f)),S&&(u-=f-(f=S._start))),this._tTime=u,this._time=f,this._act=!x,this._initted||(this._onUpdate=this.vars.onUpdate,this._initted=1,this._zTime=i,o=0),!o&&f&&!s&&!_&&(Qe(this,"onStart"),this._tTime!==u))return this;if(f>=o&&i>=0)for(p=this._first;p;){if(g=p._next,(p._act||f>=p._start)&&p._ts&&S!==p){if(p.parent!==this)return this.render(i,s,a);if(p.render(p._ts>0?(f-p._start)*p._ts:(p._dirty?p.totalDuration():p._tDur)+(f-p._start)*p._ts,s,a),f!==this._time||!this._ts&&!d){S=0,g&&(u+=this._zTime=-Jt);break}}p=g}else{p=this._last;for(var A=i<0?i:f;p;){if(g=p._prev,(p._act||A<=p._end)&&p._ts&&S!==p){if(p.parent!==this)return this.render(i,s,a);if(p.render(p._ts>0?(A-p._start)*p._ts:(p._dirty?p.totalDuration():p._tDur)+(A-p._start)*p._ts,s,a||ye&&(p._initted||p._startAt)),f!==this._time||!this._ts&&!d){S=0,g&&(u+=this._zTime=A?-Jt:Jt);break}}p=g}}if(S&&!s&&(this.pause(),S.render(f>=o?0:-Jt)._zTime=f>=o?1:-1,this._ts))return this._start=M,$s(this),this.render(i,s,a);this._onUpdate&&!s&&Qe(this,"onUpdate",!0),(u===l&&this._tTime>=this.totalDuration()||!u&&o)&&(M===this._start||Math.abs(x)!==Math.abs(this._ts))&&(this._lock||((i||!c)&&(u===l&&this._ts>0||!u&&this._ts<0)&&Jn(this,1),!s&&!(i<0&&!o)&&(u||o||!l)&&(Qe(this,u===l&&i>=0?"onComplete":"onReverseComplete",!0),this._prom&&!(u<l&&this.timeScale()>0)&&this._prom())))}return this},e.add=function(i,s){var a=this;if(Nn(s)||(s=Ye(this,s,i)),!(i instanceof cr)){if(Ee(i))return i.forEach(function(o){return a.add(o,s)}),this;if(pe(i))return this.addLabel(i,s);if(te(i))i=le.delayedCall(0,i);else return this}return this!==i?mn(this,i,s):this},e.getChildren=function(i,s,a,o){i===void 0&&(i=!0),s===void 0&&(s=!0),a===void 0&&(a=!0),o===void 0&&(o=-je);for(var l=[],c=this._first;c;)c._start>=o&&(c instanceof le?s&&l.push(c):(a&&l.push(c),i&&l.push.apply(l,c.getChildren(!0,s,a)))),c=c._next;return l},e.getById=function(i){for(var s=this.getChildren(1,1,1),a=s.length;a--;)if(s[a].vars.id===i)return s[a]},e.remove=function(i){return pe(i)?this.removeLabel(i):te(i)?this.killTweensOf(i):(js(this,i),i===this._recent&&(this._recent=this._last),vi(this))},e.totalTime=function(i,s){return arguments.length?(this._forcing=1,!this._dp&&this._ts&&(this._start=_e(He.time-(this._ts>0?i/this._ts:(this.totalDuration()-i)/-this._ts))),r.prototype.totalTime.call(this,i,s),this._forcing=0,this):this._tTime},e.addLabel=function(i,s){return this.labels[i]=Ye(this,s),this},e.removeLabel=function(i){return delete this.labels[i],this},e.addPause=function(i,s,a){var o=le.delayedCall(0,s||Hr,a);return o.data="isPause",this._hasPause=1,mn(this,o,Ye(this,i))},e.removePause=function(i){var s=this._first;for(i=Ye(this,i);s;)s._start===i&&s.data==="isPause"&&Jn(s),s=s._next},e.killTweensOf=function(i,s,a){for(var o=this.getTweensOf(i,a),l=o.length;l--;)Hn!==o[l]&&o[l].kill(i,s);return this},e.getTweensOf=function(i,s){for(var a=[],o=$e(i),l=this._first,c=Nn(s),u;l;)l instanceof le?av(l._targets,o)&&(c?(!Hn||l._initted&&l._ts)&&l.globalTime(0)<=s&&l.globalTime(l.totalDuration())>s:!s||l.isActive())&&a.push(l):(u=l.getTweensOf(o,s)).length&&a.push.apply(a,u),l=l._next;return a},e.tweenTo=function(i,s){s=s||{};var a=this,o=Ye(a,i),l=s,c=l.startAt,u=l.onStart,h=l.onStartParams,f=l.immediateRender,p,g=le.to(a,tn({ease:s.ease||"none",lazy:!1,immediateRender:!1,time:o,overwrite:"auto",duration:s.duration||Math.abs((o-(c&&"time"in c?c.time:a._time))/a.timeScale())||Jt,onStart:function(){if(a.pause(),!p){var m=s.duration||Math.abs((o-(c&&"time"in c?c.time:a._time))/a.timeScale());g._dur!==m&&or(g,m,0,1).render(g._time,!0,!0),p=1}u&&u.apply(g,h||[])}},s));return f?g.render(0):g},e.tweenFromTo=function(i,s,a){return this.tweenTo(s,tn({startAt:{time:Ye(this,i)}},a))},e.recent=function(){return this._recent},e.nextLabel=function(i){return i===void 0&&(i=this._time),Ic(this,Ye(this,i))},e.previousLabel=function(i){return i===void 0&&(i=this._time),Ic(this,Ye(this,i),1)},e.currentLabel=function(i){return arguments.length?this.seek(i,!0):this.previousLabel(this._time+Jt)},e.shiftChildren=function(i,s,a){a===void 0&&(a=0);for(var o=this._first,l=this.labels,c;o;)o._start>=a&&(o._start+=i,o._end+=i),o=o._next;if(s)for(c in l)l[c]>=a&&(l[c]+=i);return vi(this)},e.invalidate=function(i){var s=this._first;for(this._lock=0;s;)s.invalidate(i),s=s._next;return r.prototype.invalidate.call(this,i)},e.clear=function(i){i===void 0&&(i=!0);for(var s=this._first,a;s;)a=s._next,this.remove(s),s=a;return this._dp&&(this._time=this._tTime=this._pTime=0),i&&(this.labels={}),vi(this)},e.totalDuration=function(i){var s=0,a=this,o=a._last,l=je,c,u,h;if(arguments.length)return a.timeScale((a._repeat<0?a.duration():a.totalDuration())/(a.reversed()?-i:i));if(a._dirty){for(h=a.parent;o;)c=o._prev,o._dirty&&o.totalDuration(),u=o._start,u>l&&a._sort&&o._ts&&!a._lock?(a._lock=1,mn(a,o,u-o._delay,1)._lock=0):l=u,u<0&&o._ts&&(s-=u,(!h&&!a._dp||h&&h.smoothChildTiming)&&(a._start+=u/a._ts,a._time-=u,a._tTime-=u),a.shiftChildren(-u,!1,-1/0),l=0),o._end>s&&o._ts&&(s=o._end),o=c;or(a,a===jt&&a._time>s?a._time:s,1,1),a._dirty=0}return a._tDur},t.updateRoot=function(i){if(jt._ts&&(Wu(jt,zs(i,jt)),Hu=He.frame),He.frame>=Pc){Pc+=Ve.autoSleep||120;var s=jt._first;if((!s||!s._ts)&&Ve.autoSleep&&He._listeners.length<2){for(;s&&!s._ts;)s=s._next;s||He.sleep()}}},t}(cr);tn(De.prototype,{_lock:0,_hasPause:0,_forcing:0});var Cv=function(t,e,n,i,s,a,o){var l=new Fe(this._pt,t,e,0,1,vh,null,s),c=0,u=0,h,f,p,g,_,m,d,S;for(l.b=n,l.e=i,n+="",i+="",(d=~i.indexOf("random("))&&(i=Vr(i)),a&&(S=[n,i],a(S,t,e),n=S[0],i=S[1]),f=n.match(za)||[];h=za.exec(i);)g=h[0],_=i.substring(c,h.index),p?p=(p+1)%5:_.substr(-5)==="rgba("&&(p=1),g!==f[u++]&&(m=parseFloat(f[u-1])||0,l._pt={_next:l._pt,p:_||u===1?_:",",s:m,c:g.charAt(1)==="="?ji(m,g)-m:parseFloat(g)-m,m:p&&p<4?Math.round:0},c=za.lastIndex);return l.c=c<i.length?i.substring(c,i.length):"",l.fp=o,(Ou.test(i)||d)&&(l.e=0),this._pt=l,l},qo=function(t,e,n,i,s,a,o,l,c,u){te(i)&&(i=i(s||0,t,a));var h=t[e],f=n!=="get"?n:te(h)?c?t[e.indexOf("set")||!te(t["get"+e.substr(3)])?e:"get"+e.substr(3)](c):t[e]():h,p=te(h)?c?Iv:_h:Zo,g;if(pe(i)&&(~i.indexOf("random(")&&(i=Vr(i)),i.charAt(1)==="="&&(g=ji(f,i)+(Se(f)||0),(g||g===0)&&(i=g))),!u||f!==i||xo)return!isNaN(f*i)&&i!==""?(g=new Fe(this._pt,t,e,+f||0,i-(f||0),typeof h=="boolean"?Fv:gh,0,p),c&&(g.fp=c),o&&g.modifier(o,this,t),this._pt=g):(!h&&!(e in t)&&Ho(e,i),Cv.call(this,t,e,f,i,p,l||Ve.stringFilter,c))},Pv=function(t,e,n,i,s){if(te(t)&&(t=Ur(t,s,e,n,i)),!Sn(t)||t.style&&t.nodeType||Ee(t)||Nu(t))return pe(t)?Ur(t,s,e,n,i):t;var a={},o;for(o in t)a[o]=Ur(t[o],s,e,n,i);return a},dh=function(t,e,n,i,s,a){var o,l,c,u;if(ke[t]&&(o=new ke[t]).init(s,o.rawVars?e[t]:Pv(e[t],i,s,a,n),n,i,a)!==!1&&(n._pt=l=new Fe(n._pt,s,t,0,1,o.render,o,0,o.priority),n!==qi))for(c=n._ptLookup[n._targets.indexOf(s)],u=o._props.length;u--;)c[o._props[u]]=l;return o},Hn,xo,Yo=function r(t,e,n){var i=t.vars,s=i.ease,a=i.startAt,o=i.immediateRender,l=i.lazy,c=i.onUpdate,u=i.onUpdateParams,h=i.callbackScope,f=i.runBackwards,p=i.yoyoEase,g=i.keyframes,_=i.autoRevert,m=t._dur,d=t._startAt,S=t._targets,x=t.parent,M=x&&x.data==="nested"?x.vars.targets:S,y=t._overwrite==="auto"&&!zo,T=t.timeline,R,C,v,A,z,V,U,N,O,q,G,H,tt;if(T&&(!g||!s)&&(s="none"),t._ease=xi(s,sr.ease),t._yEase=p?ch(xi(p===!0?s:p,sr.ease)):0,p&&t._yoyo&&!t._repeat&&(p=t._yEase,t._yEase=t._ease,t._ease=p),t._from=!T&&!!i.runBackwards,!T||g&&!i.stagger){if(N=S[0]?gi(S[0]).harness:0,H=N&&i[N.prop],R=Os(i,Vo),d&&(d._zTime<0&&d.progress(1),e<0&&f&&o&&!_?d.render(-1,!0):d.revert(f&&m?Ps:rv),d._lazy=0),a){if(Jn(t._startAt=le.set(S,tn({data:"isStart",overwrite:!1,parent:x,immediateRender:!0,lazy:!d&&Ie(l),startAt:null,delay:0,onUpdate:c,onUpdateParams:u,callbackScope:h,stagger:0},a))),t._startAt._dp=0,t._startAt._sat=t,e<0&&(ye||!o&&!_)&&t._startAt.revert(Ps),o&&m&&e<=0&&n<=0){e&&(t._zTime=e);return}}else if(f&&m&&!d){if(e&&(o=!1),v=tn({overwrite:!1,data:"isFromStart",lazy:o&&!d&&Ie(l),immediateRender:o,stagger:0,parent:x},R),H&&(v[N.prop]=H),Jn(t._startAt=le.set(S,v)),t._startAt._dp=0,t._startAt._sat=t,e<0&&(ye?t._startAt.revert(Ps):t._startAt.render(-1,!0)),t._zTime=e,!o)r(t._startAt,Jt,Jt);else if(!e)return}for(t._pt=t._ptCache=0,l=m&&Ie(l)||l&&!m,C=0;C<S.length;C++){if(z=S[C],U=z._gsap||Xo(S)[C]._gsap,t._ptLookup[C]=q={},fo[U.id]&&qn.length&&Fs(),G=M===S?C:M.indexOf(z),N&&(O=new N).init(z,H||R,t,G,M)!==!1&&(t._pt=A=new Fe(t._pt,z,O.name,0,1,O.render,O,0,O.priority),O._props.forEach(function(j){q[j]=A}),O.priority&&(V=1)),!N||H)for(v in R)ke[v]&&(O=dh(v,R,t,G,z,M))?O.priority&&(V=1):q[v]=A=qo.call(t,z,v,"get",R[v],G,M,0,i.stringFilter);t._op&&t._op[C]&&t.kill(z,t._op[C]),y&&t._pt&&(Hn=t,jt.killTweensOf(z,q,t.globalTime(e)),tt=!t.parent,Hn=0),t._pt&&l&&(fo[U.id]=1)}V&&xh(t),t._onInit&&t._onInit(t)}t._onUpdate=c,t._initted=(!t._op||t._pt)&&!tt,g&&e<=0&&T.render(je,!0,!0)},Lv=function(t,e,n,i,s,a,o){var l=(t._pt&&t._ptCache||(t._ptCache={}))[e],c,u,h,f;if(!l)for(l=t._ptCache[e]=[],h=t._ptLookup,f=t._targets.length;f--;){if(c=h[f][e],c&&c.d&&c.d._pt)for(c=c.d._pt;c&&c.p!==e&&c.fp!==e;)c=c._next;if(!c)return xo=1,t.vars[e]="+=0",Yo(t,o),xo=0,1;l.push(c)}for(f=l.length;f--;)u=l[f],c=u._pt||u,c.s=(i||i===0)&&!s?i:c.s+(i||0)+a*c.c,c.c=n-c.s,u.e&&(u.e=ie(n)+Se(u.e)),u.b&&(u.b=c.s+Se(u.b))},Dv=function(t,e){var n=t[0]?gi(t[0]).harness:0,i=n&&n.aliases,s,a,o,l;if(!i)return e;s=yi({},e);for(a in i)if(a in s)for(l=i[a].split(","),o=l.length;o--;)s[l[o]]=s[a];return s},Uv=function(t,e,n,i){var s=e.ease||i||"power1.inOut",a,o;if(Ee(e))o=n[t]||(n[t]=[]),e.forEach(function(l,c){return o.push({t:c/(e.length-1)*100,v:l,e:s})});else for(a in e)o=n[a]||(n[a]=[]),a==="ease"||o.push({t:parseFloat(t),v:e[a],e:s})},Ur=function(t,e,n,i,s){return te(t)?t.call(e,n,i,s):pe(t)&&~t.indexOf("random(")?Vr(t):t},ph=Wo+"repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,autoRevert",mh={};Ne(ph+",id,stagger,delay,duration,paused,scrollTrigger",function(r){return mh[r]=1});var le=function(r){Uu(t,r);function t(n,i,s,a){var o;typeof i=="number"&&(s.duration=i,i=s,s=null),o=r.call(this,a?i:Lr(i))||this;var l=o.vars,c=l.duration,u=l.delay,h=l.immediateRender,f=l.stagger,p=l.overwrite,g=l.keyframes,_=l.defaults,m=l.scrollTrigger,d=l.yoyoEase,S=i.parent||jt,x=(Ee(n)||Nu(n)?Nn(n[0]):"length"in i)?[n]:$e(n),M,y,T,R,C,v,A,z;if(o._targets=x.length?Xo(x):Ns("GSAP target "+n+" not found. https://greensock.com",!Ve.nullTargetWarn)||[],o._ptLookup=[],o._overwrite=p,g||f||As(c)||As(u)){if(i=o.vars,M=o.timeline=new De({data:"nested",defaults:_||{},targets:S&&S.data==="nested"?S.vars.targets:x}),M.kill(),M.parent=M._dp=Ln(o),M._start=0,f||As(c)||As(u)){if(R=x.length,A=f&&Qu(f),Sn(f))for(C in f)~ph.indexOf(C)&&(z||(z={}),z[C]=f[C]);for(y=0;y<R;y++)T=Os(i,mh),T.stagger=0,d&&(T.yoyoEase=d),z&&yi(T,z),v=x[y],T.duration=+Ur(c,Ln(o),y,v,x),T.delay=(+Ur(u,Ln(o),y,v,x)||0)-o._delay,!f&&R===1&&T.delay&&(o._delay=u=T.delay,o._start+=u,T.delay=0),M.to(v,T,A?A(y,v,x):0),M._ease=Gt.none;M.duration()?c=u=0:o.timeline=0}else if(g){Lr(tn(M.vars.defaults,{ease:"none"})),M._ease=xi(g.ease||i.ease||"none");var V=0,U,N,O;if(Ee(g))g.forEach(function(q){return M.to(x,q,">")}),M.duration();else{T={};for(C in g)C==="ease"||C==="easeEach"||Uv(C,g[C],T,g.easeEach);for(C in T)for(U=T[C].sort(function(q,G){return q.t-G.t}),V=0,y=0;y<U.length;y++)N=U[y],O={ease:N.e,duration:(N.t-(y?U[y-1].t:0))/100*c},O[C]=N.v,M.to(x,O,V),V+=O.duration;M.duration()<c&&M.to({},{duration:c-M.duration()})}}c||o.duration(c=M.duration())}else o.timeline=0;return p===!0&&!zo&&(Hn=Ln(o),jt.killTweensOf(x),Hn=0),mn(S,Ln(o),s),i.reversed&&o.reverse(),i.paused&&o.paused(!0),(h||!c&&!g&&o._start===_e(S._time)&&Ie(h)&&uv(Ln(o))&&S.data!=="nested")&&(o._tTime=-Jt,o.render(Math.max(0,-u)||0)),m&&Ku(Ln(o),m),o}var e=t.prototype;return e.render=function(i,s,a){var o=this._time,l=this._tDur,c=this._dur,u=i<0,h=i>l-Jt&&!u?l:i<Jt?0:i,f,p,g,_,m,d,S,x,M;if(!c)fv(this,i,s,a);else if(h!==this._tTime||!i||a||!this._initted&&this._tTime||this._startAt&&this._zTime<0!==u){if(f=h,x=this.timeline,this._repeat){if(_=c+this._rDelay,this._repeat<-1&&u)return this.totalTime(_*100+i,s,a);if(f=_e(h%_),h===l?(g=this._repeat,f=c):(g=~~(h/_),g&&g===h/_&&(f=c,g--),f>c&&(f=c)),d=this._yoyo&&g&1,d&&(M=this._yEase,f=c-f),m=ar(this._tTime,_),f===o&&!a&&this._initted)return this._tTime=h,this;g!==m&&(x&&this._yEase&&uh(x,d),this.vars.repeatRefresh&&!d&&!this._lock&&(this._lock=a=1,this.render(_e(_*g),!0).invalidate()._lock=0))}if(!this._initted){if(Ju(this,u?i:f,a,s,h))return this._tTime=0,this;if(o!==this._time)return this;if(c!==this._dur)return this.render(i,s,a)}if(this._tTime=h,this._time=f,!this._act&&this._ts&&(this._act=1,this._lazy=0),this.ratio=S=(M||this._ease)(f/c),this._from&&(this.ratio=S=1-S),f&&!o&&!s&&!g&&(Qe(this,"onStart"),this._tTime!==h))return this;for(p=this._pt;p;)p.r(S,p.d),p=p._next;x&&x.render(i<0?i:!f&&d?-Jt:x._dur*x._ease(f/this._dur),s,a)||this._startAt&&(this._zTime=i),this._onUpdate&&!s&&(u&&po(this,i,s,a),Qe(this,"onUpdate")),this._repeat&&g!==m&&this.vars.onRepeat&&!s&&this.parent&&Qe(this,"onRepeat"),(h===this._tDur||!h)&&this._tTime===h&&(u&&!this._onUpdate&&po(this,i,!0,!0),(i||!c)&&(h===this._tDur&&this._ts>0||!h&&this._ts<0)&&Jn(this,1),!s&&!(u&&!o)&&(h||o||d)&&(Qe(this,h===l?"onComplete":"onReverseComplete",!0),this._prom&&!(h<l&&this.timeScale()>0)&&this._prom()))}return this},e.targets=function(){return this._targets},e.invalidate=function(i){return(!i||!this.vars.runBackwards)&&(this._startAt=0),this._pt=this._op=this._onUpdate=this._lazy=this.ratio=0,this._ptLookup=[],this.timeline&&this.timeline.invalidate(i),r.prototype.invalidate.call(this,i)},e.resetTo=function(i,s,a,o){Wr||He.wake(),this._ts||this.play();var l=Math.min(this._dur,(this._dp._time-this._start)*this._ts),c;return this._initted||Yo(this,l),c=this._ease(l/this._dur),Lv(this,i,s,a,o,c,l)?this.resetTo(i,s,a,o):(Qs(this,0),this.parent||Yu(this._dp,this,"_first","_last",this._dp._sort?"_start":0),this.render(0))},e.kill=function(i,s){if(s===void 0&&(s="all"),!i&&(!s||s==="all"))return this._lazy=this._pt=0,this.parent?Tr(this):this;if(this.timeline){var a=this.timeline.totalDuration();return this.timeline.killTweensOf(i,s,Hn&&Hn.vars.overwrite!==!0)._first||Tr(this),this.parent&&a!==this.timeline.totalDuration()&&or(this,this._dur*this.timeline._tDur/a,0,1),this}var o=this._targets,l=i?$e(i):o,c=this._ptLookup,u=this._pt,h,f,p,g,_,m,d;if((!s||s==="all")&&lv(o,l))return s==="all"&&(this._pt=0),Tr(this);for(h=this._op=this._op||[],s!=="all"&&(pe(s)&&(_={},Ne(s,function(S){return _[S]=1}),s=_),s=Dv(o,s)),d=o.length;d--;)if(~l.indexOf(o[d])){f=c[d],s==="all"?(h[d]=s,g=f,p={}):(p=h[d]=h[d]||{},g=s);for(_ in g)m=f&&f[_],m&&((!("kill"in m.d)||m.d.kill(_)===!0)&&js(this,m,"_pt"),delete f[_]),p!=="all"&&(p[_]=1)}return this._initted&&!this._pt&&u&&Tr(this),this},t.to=function(i,s){return new t(i,s,arguments[2])},t.from=function(i,s){return Dr(1,arguments)},t.delayedCall=function(i,s,a,o){return new t(s,0,{immediateRender:!1,lazy:!1,overwrite:!1,delay:i,onComplete:s,onReverseComplete:s,onCompleteParams:a,onReverseCompleteParams:a,callbackScope:o})},t.fromTo=function(i,s,a){return Dr(2,arguments)},t.set=function(i,s){return s.duration=0,s.repeatDelay||(s.repeat=0),new t(i,s)},t.killTweensOf=function(i,s,a){return jt.killTweensOf(i,s,a)},t}(cr);tn(le.prototype,{_targets:[],_lazy:0,_startAt:0,_op:0,_onInit:0});Ne("staggerTo,staggerFrom,staggerFromTo",function(r){le[r]=function(){var t=new De,e=_o.call(arguments,0);return e.splice(r==="staggerFromTo"?5:4,0,0),t[r].apply(t,e)}});var Zo=function(t,e,n){return t[e]=n},_h=function(t,e,n){return t[e](n)},Iv=function(t,e,n,i){return t[e](i.fp,n)},Nv=function(t,e,n){return t.setAttribute(e,n)},Ko=function(t,e){return te(t[e])?_h:Bo(t[e])&&t.setAttribute?Nv:Zo},gh=function(t,e){return e.set(e.t,e.p,Math.round((e.s+e.c*t)*1e6)/1e6,e)},Fv=function(t,e){return e.set(e.t,e.p,!!(e.s+e.c*t),e)},vh=function(t,e){var n=e._pt,i="";if(!t&&e.b)i=e.b;else if(t===1&&e.e)i=e.e;else{for(;n;)i=n.p+(n.m?n.m(n.s+n.c*t):Math.round((n.s+n.c*t)*1e4)/1e4)+i,n=n._next;i+=e.c}e.set(e.t,e.p,i,e)},Jo=function(t,e){for(var n=e._pt;n;)n.r(t,n.d),n=n._next},Ov=function(t,e,n,i){for(var s=this._pt,a;s;)a=s._next,s.p===i&&s.modifier(t,e,n),s=a},zv=function(t){for(var e=this._pt,n,i;e;)i=e._next,e.p===t&&!e.op||e.op===t?js(this,e,"_pt"):e.dep||(n=1),e=i;return!n},Bv=function(t,e,n,i){i.mSet(t,e,i.m.call(i.tween,n,i.mt),i)},xh=function(t){for(var e=t._pt,n,i,s,a;e;){for(n=e._next,i=s;i&&i.pr>e.pr;)i=i._next;(e._prev=i?i._prev:a)?e._prev._next=e:s=e,(e._next=i)?i._prev=e:a=e,e=n}t._pt=s},Fe=function(){function r(e,n,i,s,a,o,l,c,u){this.t=n,this.s=s,this.c=a,this.p=i,this.r=o||gh,this.d=l||this,this.set=c||Zo,this.pr=u||0,this._next=e,e&&(e._prev=this)}var t=r.prototype;return t.modifier=function(n,i,s){this.mSet=this.mSet||this.set,this.set=Bv,this.m=n,this.mt=s,this.tween=i},r}();Ne(Wo+"parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger",function(r){return Vo[r]=1});We.TweenMax=We.TweenLite=le;We.TimelineLite=We.TimelineMax=De;jt=new De({sortChildren:!1,defaults:sr,autoRemoveChildren:!0,id:"root",smoothChildTiming:!0});Ve.stringFilter=lh;var ur=[],Ds={},Gv=[],Fc=0,Va=function(t){return(Ds[t]||Gv).map(function(e){return e()})},Mo=function(){var t=Date.now(),e=[];t-Fc>2&&(Va("matchMediaInit"),ur.forEach(function(n){var i=n.queries,s=n.conditions,a,o,l,c;for(o in i)a=Ze.matchMedia(i[o]).matches,a&&(l=1),a!==s[o]&&(s[o]=a,c=1);c&&(n.revert(),l&&e.push(n))}),Va("matchMediaRevert"),e.forEach(function(n){return n.onMatch(n)}),Fc=t,Va("matchMedia"))},Mh=function(){function r(e,n){this.selector=n&&go(n),this.data=[],this._r=[],this.isReverted=!1,e&&this.add(e)}var t=r.prototype;return t.add=function(n,i,s){te(n)&&(s=i,i=n,n=te);var a=this,o=function(){var c=oe,u=a.selector,h;return c&&c!==a&&c.data.push(a),s&&(a.selector=go(s)),oe=a,h=i.apply(a,arguments),te(h)&&a._r.push(h),oe=c,a.selector=u,a.isReverted=!1,h};return a.last=o,n===te?o(a):n?a[n]=o:o},t.ignore=function(n){var i=oe;oe=null,n(this),oe=i},t.getTweens=function(){var n=[];return this.data.forEach(function(i){return i instanceof r?n.push.apply(n,i.getTweens()):i instanceof le&&!(i.parent&&i.parent.data==="nested")&&n.push(i)}),n},t.clear=function(){this._r.length=this.data.length=0},t.kill=function(n,i){var s=this;if(n){var a=this.getTweens();this.data.forEach(function(l){l.data==="isFlip"&&(l.revert(),l.getChildren(!0,!0,!1).forEach(function(c){return a.splice(a.indexOf(c),1)}))}),a.map(function(l){return{g:l.globalTime(0),t:l}}).sort(function(l,c){return c.g-l.g||-1}).forEach(function(l){return l.t.revert(n)}),this.data.forEach(function(l){return!(l instanceof cr)&&l.revert&&l.revert(n)}),this._r.forEach(function(l){return l(n,s)}),this.isReverted=!0}else this.data.forEach(function(l){return l.kill&&l.kill()});if(this.clear(),i){var o=ur.indexOf(this);~o&&ur.splice(o,1)}},t.revert=function(n){this.kill(n||{})},r}(),kv=function(){function r(e){this.contexts=[],this.scope=e}var t=r.prototype;return t.add=function(n,i,s){Sn(n)||(n={matches:n});var a=new Mh(0,s||this.scope),o=a.conditions={},l,c,u;this.contexts.push(a),i=a.add("onMatch",i),a.queries=n;for(c in n)c==="all"?u=1:(l=Ze.matchMedia(n[c]),l&&(ur.indexOf(a)<0&&ur.push(a),(o[c]=l.matches)&&(u=1),l.addListener?l.addListener(Mo):l.addEventListener("change",Mo)));return u&&i(a),this},t.revert=function(n){this.kill(n||{})},t.kill=function(n){this.contexts.forEach(function(i){return i.kill(n,!0)})},r}(),Bs={registerPlugin:function(){for(var t=arguments.length,e=new Array(t),n=0;n<t;n++)e[n]=arguments[n];e.forEach(function(i){return sh(i)})},timeline:function(t){return new De(t)},getTweensOf:function(t,e){return jt.getTweensOf(t,e)},getProperty:function(t,e,n,i){pe(t)&&(t=$e(t)[0]);var s=gi(t||{}).get,a=n?qu:Xu;return n==="native"&&(n=""),t&&(e?a((ke[e]&&ke[e].get||s)(t,e,n,i)):function(o,l,c){return a((ke[o]&&ke[o].get||s)(t,o,l,c))})},quickSetter:function(t,e,n){if(t=$e(t),t.length>1){var i=t.map(function(u){return Oe.quickSetter(u,e,n)}),s=i.length;return function(u){for(var h=s;h--;)i[h](u)}}t=t[0]||{};var a=ke[e],o=gi(t),l=o.harness&&(o.harness.aliases||{})[e]||e,c=a?function(u){var h=new a;qi._pt=0,h.init(t,n?u+n:u,qi,0,[t]),h.render(1,h),qi._pt&&Jo(1,qi)}:o.set(t,l);return a?c:function(u){return c(t,l,n?u+n:u,o,1)}},quickTo:function(t,e,n){var i,s=Oe.to(t,yi((i={},i[e]="+=0.1",i.paused=!0,i),n||{})),a=function(l,c,u){return s.resetTo(e,l,c,u)};return a.tween=s,a},isTweening:function(t){return jt.getTweensOf(t,!0).length>0},defaults:function(t){return t&&t.ease&&(t.ease=xi(t.ease,sr.ease)),Lc(sr,t||{})},config:function(t){return Lc(Ve,t||{})},registerEffect:function(t){var e=t.name,n=t.effect,i=t.plugins,s=t.defaults,a=t.extendTimeline;(i||"").split(",").forEach(function(o){return o&&!ke[o]&&!We[o]&&Ns(e+" effect requires "+o+" plugin.")}),Ba[e]=function(o,l,c){return n($e(o),tn(l||{},s),c)},a&&(De.prototype[e]=function(o,l,c){return this.add(Ba[e](o,Sn(l)?l:(c=l)&&{},this),c)})},registerEase:function(t,e){Gt[t]=xi(e)},parseEase:function(t,e){return arguments.length?xi(t,e):Gt},getById:function(t){return jt.getById(t)},exportRoot:function(t,e){t===void 0&&(t={});var n=new De(t),i,s;for(n.smoothChildTiming=Ie(t.smoothChildTiming),jt.remove(n),n._dp=0,n._time=n._tTime=jt._time,i=jt._first;i;)s=i._next,(e||!(!i._dur&&i instanceof le&&i.vars.onComplete===i._targets[0]))&&mn(n,i,i._start-i._delay),i=s;return mn(jt,n,0),n},context:function(t,e){return t?new Mh(t,e):oe},matchMedia:function(t){return new kv(t)},matchMediaRefresh:function(){return ur.forEach(function(t){var e=t.conditions,n,i;for(i in e)e[i]&&(e[i]=!1,n=1);n&&t.revert()})||Mo()},addEventListener:function(t,e){var n=Ds[t]||(Ds[t]=[]);~n.indexOf(e)||n.push(e)},removeEventListener:function(t,e){var n=Ds[t],i=n&&n.indexOf(e);i>=0&&n.splice(i,1)},utils:{wrap:Mv,wrapYoyo:Sv,distribute:Qu,random:eh,snap:th,normalize:xv,getUnit:Se,clamp:mv,splitColor:ah,toArray:$e,selector:go,mapRange:ih,pipe:gv,unitize:vv,interpolate:yv,shuffle:$u},install:Gu,effects:Ba,ticker:He,updateRoot:De.updateRoot,plugins:ke,globalTimeline:jt,core:{PropTween:Fe,globals:ku,Tween:le,Timeline:De,Animation:cr,getCache:gi,_removeLinkedListItem:js,reverting:function(){return ye},context:function(t){return t&&oe&&(oe.data.push(t),t._ctx=oe),oe},suppressOverwrites:function(t){return zo=t}}};Ne("to,from,fromTo,delayedCall,set,killTweensOf",function(r){return Bs[r]=le[r]});He.add(De.updateRoot);qi=Bs.to({},{duration:0});var Hv=function(t,e){for(var n=t._pt;n&&n.p!==e&&n.op!==e&&n.fp!==e;)n=n._next;return n},Vv=function(t,e){var n=t._targets,i,s,a;for(i in e)for(s=n.length;s--;)a=t._ptLookup[s][i],a&&(a=a.d)&&(a._pt&&(a=Hv(a,i)),a&&a.modifier&&a.modifier(e[i],t,n[s],i))},Wa=function(t,e){return{name:t,rawVars:1,init:function(i,s,a){a._onInit=function(o){var l,c;if(pe(s)&&(l={},Ne(s,function(u){return l[u]=1}),s=l),e){l={};for(c in s)l[c]=e(s[c]);s=l}Vv(o,s)}}}},Oe=Bs.registerPlugin({name:"attr",init:function(t,e,n,i,s){var a,o,l;this.tween=n;for(a in e)l=t.getAttribute(a)||"",o=this.add(t,"setAttribute",(l||0)+"",e[a],i,s,0,0,a),o.op=a,o.b=l,this._props.push(a)},render:function(t,e){for(var n=e._pt;n;)ye?n.set(n.t,n.p,n.b,n):n.r(t,n.d),n=n._next}},{name:"endArray",init:function(t,e){for(var n=e.length;n--;)this.add(t,n,t[n]||0,e[n],0,0,0,0,0,1)}},Wa("roundProps",vo),Wa("modifiers"),Wa("snap",th))||Bs;le.version=De.version=Oe.version="3.11.5";Bu=1;Go()&&lr();Gt.Power0;Gt.Power1;Gt.Power2;Gt.Power3;Gt.Power4;Gt.Linear;Gt.Quad;Gt.Cubic;Gt.Quart;Gt.Quint;Gt.Strong;Gt.Elastic;Gt.Back;Gt.SteppedEase;Gt.Bounce;Gt.Sine;Gt.Expo;Gt.Circ;/*!
 * CSSPlugin 3.11.5
 * https://greensock.com
 *
 ...
 * Club GreenSock members, the agreement issued with that membership.
 * @author: Jack Doyle, jack@greensock.com
*/var Oc,Vn,$i,jo,di,zc,$o,Wv=function(){return typeof window<"u"},Fn={},ci=180/Math.PI,Qi=Math.PI/180,ki=Math.atan2,Bc=1e8,Qo=/([A-Z])/g,Xv=/(left|right|width|margin|padding|x)/i,qv=/[\s,\(]\S/,_n={autoAlpha:"opacity,visibility",scale:"scaleX,scaleY",alpha:"opacity"},So=function(t,e){return e.set(e.t,e.p,Math.round((e.s+e.c*t)*1e4)/1e4+e.u,e)},Yv=function(t,e){return e.set(e.t,e.p,t===1?e.e:Math.round((e.s+e.c*t)*1e4)/1e4+e.u,e)},Zv=function(t,e){return e.set(e.t,e.p,t?Math.round((e.s+e.c*t)*1e4)/1e4+e.u:e.b,e)},Kv=function(t,e){var n=e.s+e.c*t;e.set(e.t,e.p,~~(n+(n<0?-.5:.5))+e.u,e)},Sh=function(t,e){return e.set(e.t,e.p,t?e.e:e.b,e)},yh=function(t,e){return e.set(e.t,e.p,t!==1?e.b:e.e,e)},Jv=function(t,e,n){return t.style[e]=n},jv=function(t,e,n){return t.style.setProperty(e,n)},$v=function(t,e,n){return t._gsap[e]=n},Qv=function(t,e,n){return t._gsap.scaleX=t._gsap.scaleY=n},tx=function(t,e,n,i,s){var a=t._gsap;a.scaleX=a.scaleY=n,a.renderTransform(s,a)},ex=function(t,e,n,i,s){var a=t._gsap;a[e]=n,a.renderTransform(s,a)},Qt="transform",hn=Qt+"Origin",nx=function r(t,e){var n=this,i=this.target,s=i.style;if(t in Fn){if(this.tfm=this.tfm||{},t!=="transform")t=_n[t]||t,~t.indexOf(",")?t.split(",").forEach(function(a){return n.tfm[a]=Dn(i,a)}):this.tfm[t]=i._gsap.x?i._gsap[t]:Dn(i,t);else return _n.transform.split(",").forEach(function(a){return r.call(n,a,e)});if(this.props.indexOf(Qt)>=0)return;i._gsap.svg&&(this.svgo=i.getAttribute("data-svg-origin"),this.props.push(hn,e,"")),t=Qt}(s||e)&&this.props.push(t,e,s[t])},Eh=function(t){t.translate&&(t.removeProperty("translate"),t.removeProperty("scale"),t.removeProperty("rotate"))},ix=function(){var t=this.props,e=this.target,n=e.style,i=e._gsap,s,a;for(s=0;s<t.length;s+=3)t[s+1]?e[t[s]]=t[s+2]:t[s+2]?n[t[s]]=t[s+2]:n.removeProperty(t[s].substr(0,2)==="--"?t[s]:t[s].replace(Qo,"-$1").toLowerCase());if(this.tfm){for(a in this.tfm)i[a]=this.tfm[a];i.svg&&(i.renderTransform(),e.setAttribute("data-svg-origin",this.svgo||"")),s=$o(),(!s||!s.isStart)&&!n[Qt]&&(Eh(n),i.uncache=1)}},Th=function(t,e){var n={target:t,props:[],revert:ix,save:nx};return t._gsap||Oe.core.getCache(t),e&&e.split(",").forEach(function(i){return n.save(i)}),n},bh,yo=function(t,e){var n=Vn.createElementNS?Vn.createElementNS((e||"http://www.w3.org/1999/xhtml").replace(/^https/,"http"),t):Vn.createElement(t);return n.style?n:Vn.createElement(t)},vn=function r(t,e,n){var i=getComputedStyle(t);return i[e]||i.getPropertyValue(e.replace(Qo,"-$1").toLowerCase())||i.getPropertyValue(e)||!n&&r(t,hr(e)||e,1)||""},Gc="O,Moz,ms,Ms,Webkit".split(","),hr=function(t,e,n){var i=e||di,s=i.style,a=5;if(t in s&&!n)return t;for(t=t.charAt(0).toUpperCase()+t.substr(1);a--&&!(Gc[a]+t in s););return a<0?null:(a===3?"ms":a>=0?Gc[a]:"")+t},Eo=function(){Wv()&&window.document&&(Oc=window,Vn=Oc.document,$i=Vn.documentElement,di=yo("div")||{style:{}},yo("div"),Qt=hr(Qt),hn=Qt+"Origin",di.style.cssText="border-width:0;line-height:0;position:absolute;padding:0",bh=!!hr("perspective"),$o=Oe.core.reverting,jo=1)},Xa=function r(t){var e=yo("svg",this.ownerSVGElement&&this.ownerSVGElement.getAttribute("xmlns")||"http://www.w3.org/2000/svg"),n=this.parentNode,i=this.nextSibling,s=this.style.cssText,a;if($i.appendChild(e),e.appendChild(this),this.style.display="block",t)try{a=this.getBBox(),this._gsapBBox=this.getBBox,this.getBBox=r}catch{}else this._gsapBBox&&(a=this._gsapBBox());return n&&(i?n.insertBefore(this,i):n.appendChild(this)),$i.removeChild(e),this.style.cssText=s,a},kc=function(t,e){for(var n=e.length;n--;)if(t.hasAttribute(e[n]))return t.getAttribute(e[n])},Ah=function(t){var e;try{e=t.getBBox()}catch{e=Xa.call(t,!0)}return e&&(e.width||e.height)||t.getBBox===Xa||(e=Xa.call(t,!0)),e&&!e.width&&!e.x&&!e.y?{x:+kc(t,["x","cx","x1"])||0,y:+kc(t,["y","cy","y1"])||0,width:0,height:0}:e},wh=function(t){return!!(t.getCTM&&(!t.parentNode||t.ownerSVGElement)&&Ah(t))},Xr=function(t,e){if(e){var n=t.style;e in Fn&&e!==hn&&(e=Qt),n.removeProperty?((e.substr(0,2)==="ms"||e.substr(0,6)==="webkit")&&(e="-"+e),n.removeProperty(e.replace(Qo,"-$1").toLowerCase())):n.removeAttribute(e)}},Wn=function(t,e,n,i,s,a){var o=new Fe(t._pt,e,n,0,1,a?yh:Sh);return t._pt=o,o.b=i,o.e=s,t._props.push(n),o},Hc={deg:1,rad:1,turn:1},rx={grid:1,flex:1},jn=function r(t,e,n,i){var s=parseFloat(n)||0,a=(n+"").trim().substr((s+"").length)||"px",o=di.style,l=Xv.test(e),c=t.tagName.toLowerCase()==="svg",u=(c?"client":"offset")+(l?"Width":"Height"),h=100,f=i==="px",p=i==="%",g,_,m,d;return i===a||!s||Hc[i]||Hc[a]?s:(a!=="px"&&!f&&(s=r(t,e,n,"px")),d=t.getCTM&&wh(t),(p||a==="%")&&(Fn[e]||~e.indexOf("adius"))?(g=d?t.getBBox()[l?"width":"height"]:t[u],ie(p?s/g*h:s/100*g)):(o[l?"width":"height"]=h+(f?a:i),_=~e.indexOf("adius")||i==="em"&&t.appendChild&&!c?t:t.parentNode,d&&(_=(t.ownerSVGElement||{}).parentNode),(!_||_===Vn||!_.appendChild)&&(_=Vn.body),m=_._gsap,m&&p&&m.width&&l&&m.time===He.time&&!m.uncache?ie(s/m.width*h):((p||a==="%")&&!rx[vn(_,"display")]&&(o.position=vn(t,"position")),_===t&&(o.position="static"),_.appendChild(di),g=di[u],_.removeChild(di),o.position="absolute",l&&p&&(m=gi(_),m.time=He.time,m.width=_[u]),ie(f?g*s/h:g&&s?h/g*s:0))))},Dn=function(t,e,n,i){var s;return jo||Eo(),e in _n&&e!=="transform"&&(e=_n[e],~e.indexOf(",")&&(e=e.split(",")[0])),Fn[e]&&e!=="transform"?(s=Yr(t,i),s=e!=="transformOrigin"?s[e]:s.svg?s.origin:ks(vn(t,hn))+" "+s.zOrigin+"px"):(s=t.style[e],(!s||s==="auto"||i||~(s+"").indexOf("calc("))&&(s=Gs[e]&&Gs[e](t,e,n)||vn(t,e)||Vu(t,e)||(e==="opacity"?1:0))),n&&!~(s+"").trim().indexOf(" ")?jn(t,e,s,n)+n:s},sx=function(t,e,n,i){if(!n||n==="none"){var s=hr(e,t,1),a=s&&vn(t,s,1);a&&a!==n?(e=s,n=a):e==="borderColor"&&(n=vn(t,"borderTopColor"))}var o=new Fe(this._pt,t.style,e,0,1,vh),l=0,c=0,u,h,f,p,g,_,m,d,S,x,M,y;if(o.b=n,o.e=i,n+="",i+="",i==="auto"&&(t.style[e]=i,i=vn(t,e)||i,t.style[e]=n),u=[n,i],lh(u),n=u[0],i=u[1],f=n.match(Xi)||[],y=i.match(Xi)||[],y.length){for(;h=Xi.exec(i);)m=h[0],S=i.substring(l,h.index),g?g=(g+1)%5:(S.substr(-5)==="rgba("||S.substr(-5)==="hsla(")&&(g=1),m!==(_=f[c++]||"")&&(p=parseFloat(_)||0,M=_.substr((p+"").length),m.charAt(1)==="="&&(m=ji(p,m)+M),d=parseFloat(m),x=m.substr((d+"").length),l=Xi.lastIndex-x.length,x||(x=x||Ve.units[e]||M,l===i.length&&(i+=x,o.e+=x)),M!==x&&(p=jn(t,e,_,x)||0),o._pt={_next:o._pt,p:S||c===1?S:",",s:p,c:d-p,m:g&&g<4||e==="zIndex"?Math.round:0});o.c=l<i.length?i.substring(l,i.length):""}else o.r=e==="display"&&i==="none"?yh:Sh;return Ou.test(i)&&(o.e=0),this._pt=o,o},Vc={top:"0%",bottom:"100%",left:"0%",right:"100%",center:"50%"},ax=function(t){var e=t.split(" "),n=e[0],i=e[1]||"50%";return(n==="top"||n==="bottom"||i==="left"||i==="right")&&(t=n,n=i,i=t),e[0]=Vc[n]||n,e[1]=Vc[i]||i,e.join(" ")},ox=function(t,e){if(e.tween&&e.tween._time===e.tween._dur){var n=e.t,i=n.style,s=e.u,a=n._gsap,o,l,c;if(s==="all"||s===!0)i.cssText="",l=1;else for(s=s.split(","),c=s.length;--c>-1;)o=s[c],Fn[o]&&(l=1,o=o==="transformOrigin"?hn:Qt),Xr(n,o);l&&(Xr(n,Qt),a&&(a.svg&&n.removeAttribute("transform"),Yr(n,1),a.uncache=1,Eh(i)))}},Gs={clearProps:function(t,e,n,i,s){if(s.data!=="isFromStart"){var a=t._pt=new Fe(t._pt,e,n,0,0,ox);return a.u=i,a.pr=-10,a.tween=s,t._props.push(n),1}}},qr=[1,0,0,1,0,0],Rh={},Ch=function(t){return t==="matrix(1, 0, 0, 1, 0, 0)"||t==="none"||!t},Wc=function(t){var e=vn(t,Qt);return Ch(e)?qr:e.substr(7).match(Fu).map(ie)},tl=function(t,e){var n=t._gsap||gi(t),i=t.style,s=Wc(t),a,o,l,c;return n.svg&&t.getAttribute("transform")?(l=t.transform.baseVal.consolidate().matrix,s=[l.a,l.b,l.c,l.d,l.e,l.f],s.join(",")==="1,0,0,1,0,0"?qr:s):(s===qr&&!t.offsetParent&&t!==$i&&!n.svg&&(l=i.display,i.display="block",a=t.parentNode,(!a||!t.offsetParent)&&(c=1,o=t.nextElementSibling,$i.appendChild(t)),s=Wc(t),l?i.display=l:Xr(t,"display"),c&&(o?a.insertBefore(t,o):a?a.appendChild(t):$i.removeChild(t))),e&&s.length>6?[s[0],s[1],s[4],s[5],s[12],s[13]]:s)},To=function(t,e,n,i,s,a){var o=t._gsap,l=s||tl(t,!0),c=o.xOrigin||0,u=o.yOrigin||0,h=o.xOffset||0,f=o.yOffset||0,p=l[0],g=l[1],_=l[2],m=l[3],d=l[4],S=l[5],x=e.split(" "),M=parseFloat(x[0])||0,y=parseFloat(x[1])||0,T,R,C,v;n?l!==qr&&(R=p*m-g*_)&&(C=M*(m/R)+y*(-_/R)+(_*S-m*d)/R,v=M*(-g/R)+y*(p/R)-(p*S-g*d)/R,M=C,y=v):(T=Ah(t),M=T.x+(~x[0].indexOf("%")?M/100*T.width:M),y=T.y+(~(x[1]||x[0]).indexOf("%")?y/100*T.height:y)),i||i!==!1&&o.smooth?(d=M-c,S=y-u,o.xOffset=h+(d*p+S*_)-d,o.yOffset=f+(d*g+S*m)-S):o.xOffset=o.yOffset=0,o.xOrigin=M,o.yOrigin=y,o.smooth=!!i,o.origin=e,o.originIsAbsolute=!!n,t.style[hn]="0px 0px",a&&(Wn(a,o,"xOrigin",c,M),Wn(a,o,"yOrigin",u,y),Wn(a,o,"xOffset",h,o.xOffset),Wn(a,o,"yOffset",f,o.yOffset)),t.setAttribute("data-svg-origin",M+" "+y)},Yr=function(t,e){var n=t._gsap||new fh(t);if("x"in n&&!e&&!n.uncache)return n;var i=t.style,s=n.scaleX<0,a="px",o="deg",l=getComputedStyle(t),c=vn(t,hn)||"0",u,h,f,p,g,_,m,d,S,x,M,y,T,R,C,v,A,z,V,U,N,O,q,G,H,tt,j,dt,it,k,J,at;return u=h=f=_=m=d=S=x=M=0,p=g=1,n.svg=!!(t.getCTM&&wh(t)),l.translate&&((l.translate!=="none"||l.scale!=="none"||l.rotate!=="none")&&(i[Qt]=(l.translate!=="none"?"translate3d("+(l.translate+" 0 0").split(" ").slice(0,3).join(", ")+") ":"")+(l.rotate!=="none"?"rotate("+l.rotate+") ":"")+(l.scale!=="none"?"scale("+l.scale.split(" ").join(",")+") ":"")+(l[Qt]!=="none"?l[Qt]:"")),i.scale=i.rotate=i.translate="none"),R=tl(t,n.svg),n.svg&&(n.uncache?(H=t.getBBox(),c=n.xOrigin-H.x+"px "+(n.yOrigin-H.y)+"px",G=""):G=!e&&t.getAttribute("data-svg-origin"),To(t,G||c,!!G||n.originIsAbsolute,n.smooth!==!1,R)),y=n.xOrigin||0,T=n.yOrigin||0,R!==qr&&(z=R[0],V=R[1],U=R[2],N=R[3],u=O=R[4],h=q=R[5],R.length===6?(p=Math.sqrt(z*z+V*V),g=Math.sqrt(N*N+U*U),_=z||V?ki(V,z)*ci:0,S=U||N?ki(U,N)*ci+_:0,S&&(g*=Math.abs(Math.cos(S*Qi))),n.svg&&(u-=y-(y*z+T*U),h-=T-(y*V+T*N))):(at=R[6],k=R[7],j=R[8],dt=R[9],it=R[10],J=R[11],u=R[12],h=R[13],f=R[14],C=ki(at,it),m=C*ci,C&&(v=Math.cos(-C),A=Math.sin(-C),G=O*v+j*A,H=q*v+dt*A,tt=at*v+it*A,j=O*-A+j*v,dt=q*-A+dt*v,it=at*-A+it*v,J=k*-A+J*v,O=G,q=H,at=tt),C=ki(-U,it),d=C*ci,C&&(v=Math.cos(-C),A=Math.sin(-C),G=z*v-j*A,H=V*v-dt*A,tt=U*v-it*A,J=N*A+J*v,z=G,V=H,U=tt),C=ki(V,z),_=C*ci,C&&(v=Math.cos(C),A=Math.sin(C),G=z*v+V*A,H=O*v+q*A,V=V*v-z*A,q=q*v-O*A,z=G,O=H),m&&Math.abs(m)+Math.abs(_)>359.9&&(m=_=0,d=180-d),p=ie(Math.sqrt(z*z+V*V+U*U)),g=ie(Math.sqrt(q*q+at*at)),C=ki(O,q),S=Math.abs(C)>2e-4?C*ci:0,M=J?1/(J<0?-J:J):0),n.svg&&(G=t.getAttribute("transform"),n.forceCSS=t.setAttribute("transform","")||!Ch(vn(t,Qt)),G&&t.setAttribute("transform",G))),Math.abs(S)>90&&Math.abs(S)<270&&(s?(p*=-1,S+=_<=0?180:-180,_+=_<=0?180:-180):(g*=-1,S+=S<=0?180:-180)),e=e||n.uncache,n.x=u-((n.xPercent=u&&(!e&&n.xPercent||(Math.round(t.offsetWidth/2)===Math.round(-u)?-50:0)))?t.offsetWidth*n.xPercent/100:0)+a,n.y=h-((n.yPercent=h&&(!e&&n.yPercent||(Math.round(t.offsetHeight/2)===Math.round(-h)?-50:0)))?t.offsetHeight*n.yPercent/100:0)+a,n.z=f+a,n.scaleX=ie(p),n.scaleY=ie(g),n.rotation=ie(_)+o,n.rotationX=ie(m)+o,n.rotationY=ie(d)+o,n.skewX=S+o,n.skewY=x+o,n.transformPerspective=M+a,(n.zOrigin=parseFloat(c.split(" ")[2])||0)&&(i[hn]=ks(c)),n.xOffset=n.yOffset=0,n.force3D=Ve.force3D,n.renderTransform=n.svg?cx:bh?Ph:lx,n.uncache=0,n},ks=function(t){return(t=t.split(" "))[0]+" "+t[1]},qa=function(t,e,n){var i=Se(e);return ie(parseFloat(e)+parseFloat(jn(t,"x",n+"px",i)))+i},lx=function(t,e){e.z="0px",e.rotationY=e.rotationX="0deg",e.force3D=0,Ph(t,e)},si="0deg",Sr="0px",ai=") ",Ph=function(t,e){var n=e||this,i=n.xPercent,s=n.yPercent,a=n.x,o=n.y,l=n.z,c=n.rotation,u=n.rotationY,h=n.rotationX,f=n.skewX,p=n.skewY,g=n.scaleX,_=n.scaleY,m=n.transformPerspective,d=n.force3D,S=n.target,x=n.zOrigin,M="",y=d==="auto"&&t&&t!==1||d===!0;if(x&&(h!==si||u!==si)){var T=parseFloat(u)*Qi,R=Math.sin(T),C=Math.cos(T),v;T=parseFloat(h)*Qi,v=Math.cos(T),a=qa(S,a,R*v*-x),o=qa(S,o,-Math.sin(T)*-x),l=qa(S,l,C*v*-x+x)}m!==Sr&&(M+="perspective("+m+ai),(i||s)&&(M+="translate("+i+"%, "+s+"%) "),(y||a!==Sr||o!==Sr||l!==Sr)&&(M+=l!==Sr||y?"translate3d("+a+", "+o+", "+l+") ":"translate("+a+", "+o+ai),c!==si&&(M+="rotate("+c+ai),u!==si&&(M+="rotateY("+u+ai),h!==si&&(M+="rotateX("+h+ai),(f!==si||p!==si)&&(M+="skew("+f+", "+p+ai),(g!==1||_!==1)&&(M+="scale("+g+", "+_+ai),S.style[Qt]=M||"translate(0, 0)"},cx=function(t,e){var n=e||this,i=n.xPercent,s=n.yPercent,a=n.x,o=n.y,l=n.rotation,c=n.skewX,u=n.skewY,h=n.scaleX,f=n.scaleY,p=n.target,g=n.xOrigin,_=n.yOrigin,m=n.xOffset,d=n.yOffset,S=n.forceCSS,x=parseFloat(a),M=parseFloat(o),y,T,R,C,v;l=parseFloat(l),c=parseFloat(c),u=parseFloat(u),u&&(u=parseFloat(u),c+=u,l+=u),l||c?(l*=Qi,c*=Qi,y=Math.cos(l)*h,T=Math.sin(l)*h,R=Math.sin(l-c)*-f,C=Math.cos(l-c)*f,c&&(u*=Qi,v=Math.tan(c-u),v=Math.sqrt(1+v*v),R*=v,C*=v,u&&(v=Math.tan(u),v=Math.sqrt(1+v*v),y*=v,T*=v)),y=ie(y),T=ie(T),R=ie(R),C=ie(C)):(y=h,C=f,T=R=0),(x&&!~(a+"").indexOf("px")||M&&!~(o+"").indexOf("px"))&&(x=jn(p,"x",a,"px"),M=jn(p,"y",o,"px")),(g||_||m||d)&&(x=ie(x+g-(g*y+_*R)+m),M=ie(M+_-(g*T+_*C)+d)),(i||s)&&(v=p.getBBox(),x=ie(x+i/100*v.width),M=ie(M+s/100*v.height)),v="matrix("+y+","+T+","+R+","+C+","+x+","+M+")",p.setAttribute("transform",v),S&&(p.style[Qt]=v)},ux=function(t,e,n,i,s){var a=360,o=pe(s),l=parseFloat(s)*(o&&~s.indexOf("rad")?ci:1),c=l-i,u=i+c+"deg",h,f;return o&&(h=s.split("_")[1],h==="short"&&(c%=a,c!==c%(a/2)&&(c+=c<0?a:-a)),h==="cw"&&c<0?c=(c+a*Bc)%a-~~(c/a)*a:h==="ccw"&&c>0&&(c=(c-a*Bc)%a-~~(c/a)*a)),t._pt=f=new Fe(t._pt,e,n,i,c,Yv),f.e=u,f.u="deg",t._props.push(n),f},Xc=function(t,e){for(var n in e)t[n]=e[n];return t},hx=function(t,e,n){var i=Xc({},n._gsap),s="perspective,force3D,transformOrigin,svgOrigin",a=n.style,o,l,c,u,h,f,p,g;i.svg?(c=n.getAttribute("transform"),n.setAttribute("transform",""),a[Qt]=e,o=Yr(n,1),Xr(n,Qt),n.setAttribute("transform",c)):(c=getComputedStyle(n)[Qt],a[Qt]=e,o=Yr(n,1),a[Qt]=c);for(l in Fn)c=i[l],u=o[l],c!==u&&s.indexOf(l)<0&&(p=Se(c),g=Se(u),h=p!==g?jn(n,l,c,g):parseFloat(c),f=parseFloat(u),t._pt=new Fe(t._pt,o,l,h,f-h,So),t._pt.u=g||0,t._props.push(l));Xc(o,i)};Ne("padding,margin,Width,Radius",function(r,t){var e="Top",n="Right",i="Bottom",s="Left",a=(t<3?[e,n,i,s]:[e+s,e+n,i+n,i+s]).map(function(o){return t<2?r+o:"border"+o+r});Gs[t>1?"border"+r:r]=function(o,l,c,u,h){var f,p;if(arguments.length<4)return f=a.map(function(g){return Dn(o,g,c)}),p=f.join(" "),p.split(f[0]).length===5?f[0]:p;f=(u+"").split(" "),p={},a.forEach(function(g,_){return p[g]=f[_]=f[_]||f[(_-1)/2|0]}),o.init(l,p,h)}});var Lh={name:"css",register:Eo,targetTest:function(t){return t.style&&t.nodeType},init:function(t,e,n,i,s){var a=this._props,o=t.style,l=n.vars.startAt,c,u,h,f,p,g,_,m,d,S,x,M,y,T,R,C;jo||Eo(),this.styles=this.styles||Th(t),C=this.styles.props,this.tween=n;for(_ in e)if(_!=="autoRound"&&(u=e[_],!(ke[_]&&dh(_,e,n,i,t,s)))){if(p=typeof u,g=Gs[_],p==="function"&&(u=u.call(n,i,t,s),p=typeof u),p==="string"&&~u.indexOf("random(")&&(u=Vr(u)),g)g(this,t,_,u,n)&&(R=1);else if(_.substr(0,2)==="--")c=(getComputedStyle(t).getPropertyValue(_)+"").trim(),u+="",Yn.lastIndex=0,Yn.test(c)||(m=Se(c),d=Se(u)),d?m!==d&&(c=jn(t,_,c,d)+d):m&&(u+=m),this.add(o,"setProperty",c,u,i,s,0,0,_),a.push(_),C.push(_,0,o[_]);else if(p!=="undefined"){if(l&&_ in l?(c=typeof l[_]=="function"?l[_].call(n,i,t,s):l[_],pe(c)&&~c.indexOf("random(")&&(c=Vr(c)),Se(c+"")||(c+=Ve.units[_]||Se(Dn(t,_))||""),(c+"").charAt(1)==="="&&(c=Dn(t,_))):c=Dn(t,_),f=parseFloat(c),S=p==="string"&&u.charAt(1)==="="&&u.substr(0,2),S&&(u=u.substr(2)),h=parseFloat(u),_ in _n&&(_==="autoAlpha"&&(f===1&&Dn(t,"visibility")==="hidden"&&h&&(f=0),C.push("visibility",0,o.visibility),Wn(this,o,"visibility",f?"inherit":"hidden",h?"inherit":"hidden",!h)),_!=="scale"&&_!=="transform"&&(_=_n[_],~_.indexOf(",")&&(_=_.split(",")[0]))),x=_ in Fn,x){if(this.styles.save(_),M||(y=t._gsap,y.renderTransform&&!e.parseTransform||Yr(t,e.parseTransform),T=e.smoothOrigin!==!1&&y.smooth,M=this._pt=new Fe(this._pt,o,Qt,0,1,y.renderTransform,y,0,-1),M.dep=1),_==="scale")this._pt=new Fe(this._pt,y,"scaleY",y.scaleY,(S?ji(y.scaleY,S+h):h)-y.scaleY||0,So),this._pt.u=0,a.push("scaleY",_),_+="X";else if(_==="transformOrigin"){C.push(hn,0,o[hn]),u=ax(u),y.svg?To(t,u,0,T,0,this):(d=parseFloat(u.split(" ")[2])||0,d!==y.zOrigin&&Wn(this,y,"zOrigin",y.zOrigin,d),Wn(this,o,_,ks(c),ks(u)));continue}else if(_==="svgOrigin"){To(t,u,1,T,0,this);continue}else if(_ in Rh){ux(this,y,_,f,S?ji(f,S+u):u);continue}else if(_==="smoothOrigin"){Wn(this,y,"smooth",y.smooth,u);continue}else if(_==="force3D"){y[_]=u;continue}else if(_==="transform"){hx(this,u,t);continue}}else _ in o||(_=hr(_)||_);if(x||(h||h===0)&&(f||f===0)&&!qv.test(u)&&_ in o)m=(c+"").substr((f+"").length),h||(h=0),d=Se(u)||(_ in Ve.units?Ve.units[_]:m),m!==d&&(f=jn(t,_,c,d)),this._pt=new Fe(this._pt,x?y:o,_,f,(S?ji(f,S+h):h)-f,!x&&(d==="px"||_==="zIndex")&&e.autoRound!==!1?Kv:So),this._pt.u=d||0,m!==d&&d!=="%"&&(this._pt.b=c,this._pt.r=Zv);else if(_ in o)sx.call(this,t,_,c,S?S+u:u);else if(_ in t)this.add(t,_,c||t[_],S?S+u:u,i,s);else if(_!=="parseTransform"){Ho(_,u);continue}x||(_ in o?C.push(_,0,o[_]):C.push(_,1,c||t[_])),a.push(_)}}R&&xh(this)},render:function(t,e){if(e.tween._time||!$o())for(var n=e._pt;n;)n.r(t,n.d),n=n._next;else e.styles.revert()},get:Dn,aliases:_n,getSetter:function(t,e,n){var i=_n[e];return i&&i.indexOf(",")<0&&(e=i),e in Fn&&e!==hn&&(t._gsap.x||Dn(t,"x"))?n&&zc===n?e==="scale"?Qv:$v:(zc=n||{})&&(e==="scale"?tx:ex):t.style&&!Bo(t.style[e])?Jv:~e.indexOf("-")?jv:Ko(t,e)},core:{_removeProperty:Xr,_getMatrix:tl}};Oe.utils.checkPrefix=hr;Oe.core.getStyleSaver=Th;(function(r,t,e,n){var i=Ne(r+","+t+","+e,function(s){Fn[s]=1});Ne(t,function(s){Ve.units[s]="deg",Rh[s]=1}),_n[i[13]]=r+","+t,Ne(n,function(s){var a=s.split(":");_n[a[1]]=i[a[0]]})})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent","rotation,rotationX,rotationY,skewX,skewY","transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective","0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");Ne("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective",function(r){Ve.units[r]="px"});Oe.registerPlugin(Lh);var fr=Oe.registerPlugin(Lh)||Oe;fr.core.Tween;const fx=1e3,dx=1e3,px=5e3,mx=5e4,_x=1e3,gx=.5,Zr=-100,Hs=3100,qc=80,ws=100,bo={y:0},Yc=5,vx=.94,Vs={x:0,y:0},ta={showing:!0},Dh={clicked:!1},Ya={fov:45,near:.1,far:4e3},Za={x:0,y:200,z:-400},Uh=10,xx=20,Mx=3500,Sx=10,Zc={color:4210752,intensity:10},Ka={x:-500,y:0,z:-600},yx=[{year:1950,info:"Information for 1950",position:new D(-5,1,0)},{year:1960,info:"Information for 1960",position:new D(15,1,500)},{year:1970,info:"Information for 1970",position:new D(-5,1,1e3)},{year:1980,info:"Information for 1980",position:new D(15,1,1500)},{year:1990,info:"Information for 1990",position:new D(-5,1,2e3)},{year:2e3,info:"Information for 2000",position:new D(15,1,2500)},{year:2010,info:"Information for 2010",position:new D(-5,1,2600)},{year:2020,info:"Information for 2020",position:new D(15,1,2700)},{year:2030,info:"Information for 2030",position:new D(-5,1,2800)},{year:2040,info:"Information for 2040",position:new D(15,1,2900)},{year:2050,info:"Information for 2050",position:new D(-5,1,2950)}],Kc=[{distance:-1e3,positionOffset:new ut(0,0),lookAt:new D(0,0,0)}];function Ex(r){const t=new K0,e=yx.map(({year:n,info:i,position:s})=>new Promise(a=>{t.load("/fonts/Bebas.json",function(o){const l=new Cc(String(n),{font:o,size:3,height:.1,curveSegments:10,bevelEnabled:!0,bevelThickness:.3,bevelSize:.01,bevelOffset:0,bevelSegments:5}),c=new zr({color:"orange",transparent:!0,opacity:1}),u=new Re(l,c);u.position.x=s.x+.5,u.position.y=s.y+2,u.position.z=s.z,u.rotation.y=Math.PI,r.add(u);const h=new Cc(i,{font:o,size:1,height:0,curveSegments:10,bevelEnabled:!1}),f=new zr({color:"white",transparent:!0,opacity:1}),p=new Re(h,f);p.position.x=s.x,p.position.y=s.y,p.position.z=s.z,p.rotation.y=Math.PI,r.add(p),a({yearText:u,infoText:p})})}));return Promise.all(e)}function Tx(r,t){t.forEach(e=>{const n=r.position.distanceTo(e.yearText.position),i=r.position.distanceTo(e.infoText.position);n<ws?e.yearText.material.opacity=1-n/ws:e.yearText.material.opacity=0,e.yearText.material.needsUpdate=!0,i<ws?e.infoText.material.opacity=1-i/ws:e.infoText.material.opacity=0,e.infoText.material.needsUpdate=!0})}function bx(r,t){return new Promise((e,n)=>{try{const i=new en,s=new Tu({color:16777215,size:gx}),a=[];for(let l=0;l<mx;l++){const c=fa.randFloatSpread(fx),u=fa.randFloatSpread(dx),h=fa.randFloatSpread(px)+t;a.push(c,u,h)}i.setAttribute("position",new Pe(a,3));const o=new jg(i,s);r.add(o),e(o)}catch(i){n(i)}})}function Ax(r,t){return new Promise((e,n)=>{const i=new rr(1,8,16);t.load("/images/asteroid.jpeg",function(s){const a=new Du({map:s}),o=new Re(i,a);o.position.set(0,0,Zr),r.add(o),e(o)},void 0,function(s){n(s)})})}function wx(r){const t=Ix();r.position.z+=t,r.position.z<Zr&&(r.position.z=Zr),r.position.z>Hs&&(r.position.z=Hs)}function Rx(r,t,e){if(!ta.showing){e.position.z=r.position.z-Uh,e.position.y=r.position.y+2;let n={x:r.position.x,y:r.position.y},i=new D(t.position.x,t.position.y,t.position.z);for(let s=0;s<Kc.length;s++){const a=Kc[s];if(Math.abs(r.position.z-a.distance)<=1){n.x+=a.positionOffset.x,n.y+=a.positionOffset.y,a.lookAt&&(i=a.lookAt);break}}fr.to(e.position,{duration:5,x:n.x,y:n.y,ease:"power1",onUpdate:function(){e.lookAt(i.x,i.y,i.z)}})}}function Cx(r,t,e){const n={x:t.position.x,y:t.position.y+2,z:t.position.z-Uh};fr.to(r.position,{duration:2,x:n.x,y:n.y,z:n.z,ease:"power4",onUpdate:function(){r.lookAt(e.position.x,e.position.y,e.position.z)},onComplete:function(){ta.showing=!1}})}function Px(r){r.rotation.x+=.01}function Lx(r,t){return new Promise((e,n)=>{const i=`
    varying vec3 vNormal;
    void main() {
    ...
    `,a=new rr(qc,32,32),o=new Du,l=new rr(qc*1.1,32,32),c=new Mn({vertexShader:i,fragmentShader:s,side:Ce,blending:Ja,transparent:!0,uniforms:{opacity:{value:.2}}});(h=>new Promise((f,p)=>{t.load(h,f,void 0,p)}))("/images/earth.jpg").then(h=>{o.map=h;const f=new Re(a,o);f.userData={earthTexture:h},f.position.set(0,0,Hs),r.add(f);const p=new Re(l,c);r.add(p),p.position.set(f.position.x,f.position.y,f.position.z),e(f)}).catch(n)})}function Dx(r){r.rotation.y+=.001}function Ux(r,t){const e=new rr(Sx,10,10),n=t.load("/images/sun.jpeg"),i=new zr({map:n}),s=new Re(e,i);s.position.set(420,-10,Mx),r.add(s)}function Ix(){bo.y*=vx;let r=bo.y/1e3;return Math.abs(r)>Yc&&(r=Math.sign(r)*Yc),r}function Nx(r){if(!Dh.clicked){let t=r.position.x+Vs.x*.5;r.position.y+Vs.y*.5,t=Math.max(Math.min(t,50),-50),r.position.x=t;return}ta.showing}function Fx(r,t){r.aspect=window.innerWidth/window.innerHeight,r.updateProjectionMatrix(),t.setSize(window.innerWidth,window.innerHeight)}function Ox(r){const t=document.querySelector("#scrollbar-handle"),e=0,n=100-2*e,i=e+n*((r.position.z-Zr)/(Hs+50-Zr));t.style.top=`${i}%`}function zx(){fr.from(".title div",{y:"100%",opacity:0,ease:"power2",duration:.5,stagger:.1}),fr.from(".explore-button",{scale:0,y:"100%",opacity:0,ease:"power2",duration:.5,delay:.5})}function Ih(r,t,e,n,i,s,a){requestAnimationFrame(()=>Ih(r,t,e,n,i,s)),wx(n),Rx(n,i,e),Ox(n),Tx(e,s),Dx(i),Px(n),Nx(e),r.render(t,e)}async function Bx(){const r=new Jg,t=new N0;Ux(r,t),await bx(r,_x);const e=await Ex(r),n=await Ax(r,t),i=await Lx(r,t),s=new B0(Zc.color,Zc.intensity);s.position.set(Ka.x,Ka.y,Ka.z),r.add(s);const a=new Je(Ya.fov,window.innerWidth/window.innerHeight,Ya.near,Ya.far);a.position.set(Za.x,Za.y,Za.z),a.setFocalLength(xx),a.lookAt(i.position.x-250,i.position.y-175,i.position.z);const o=document.querySelector(".webgl"),l=new Eu({canvas:o,antialias:!0,logarithmicDepthBuffer:!1});l.setSize(window.innerWidth,window.innerHeight),l.setPixelRatio(window.devicePixelRatio);const c=new W0(r,a),u=new Z0(l);u.addPass(c),window.addEventListener("mousemove",function(h){Vs.x=h.clientX/window.innerWidth*2-1,Vs.y=-(h.clientY/window.innerHeight)*2+1}),window.addEventListener("resize",()=>Fx(a,l),!1),window.addEventListener("wheel",function(h){ta.showing||(bo.y+=h.deltaY)}),document.querySelector(".explore-button").addEventListener("click",()=>{fr.to(".title",{duration:1,y:"-550%",fontSize:"4rem",ease:"power3.out"}),document.querySelector(".explore-button").style.display="none",Dh.clicked=!0,Cx(a,n,i)}),zx(),Ih(u,r,a,n,i,e)}Bx();
